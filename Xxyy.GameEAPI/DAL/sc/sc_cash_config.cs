...
namespace Xxyy.DAL
{
    ...
    public class Sc_cash_configMO : MySqlTableMO<Sc_cash_configEO>
    {
        ...
        {
            RepairGetByPKData(operatorID, countryID, currencyID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string operatorID, string countryID, string currencyID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
