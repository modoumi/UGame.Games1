...
namespace Xxyy.DAL
{
    ...
    public class Sc_cash_audit_logMO : MySqlTableMO<Sc_cash_audit_logEO>
    {
        ...
        {
            RepairGetByPKData(auditLogID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string auditLogID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
