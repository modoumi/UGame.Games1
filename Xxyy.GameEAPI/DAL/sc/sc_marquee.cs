...
namespace Xxyy.DAL
{
    ...
    public class Sc_marqueeMO : MySqlTableMO<Sc_marqueeEO>
    {
        ...
        {
            RepairGetByPKData(marqueeID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string marqueeID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
