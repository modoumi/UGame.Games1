...
namespace Xxyy.DAL
{
    ...
    public class Sc_notify_user_logMO : MySqlTableMO<Sc_notify_user_logEO>
    {
        ...
        {
            RepairGetByPKData(notifyID, userID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string notifyID, string userID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
