...
namespace Xxyy.DAL
{
    ...
    /// <summary>
    /// 通知具体用户
    /// 【表 sc_notify_user 的实体类】
    /// </summary>
    [DataContract]
    public class Sc_notify_userEO : IRowMapper<Sc_notify_userEO>
    {
        /// <summary>
        /// 构造函数 
        /// </summary>
        public Sc_notify_userEO()
        {
        }
        #region 主键原始值 & 主键集合
        ...
        /// <return>实体对象</return>
        public Sc_notify_userEO MapRow(IDataReader reader)
        {
        ...
        /// <param name = "reader">只进结果集流</param>
        /// <return>实体对象</return>
        public static Sc_notify_userEO MapDataReader(IDataReader reader)
        {
            Sc_notify_userEO ret = new Sc_notify_userEO();
    ...
    /// <summary>
    /// 通知具体用户
    /// 【表 sc_notify_user 的操作类】
    /// </summary>
    public class Sc_notify_userMO : MySqlTableMO<Sc_notify_userEO>
    {
        /// <summary>
        /// 表名
        /// </summary>
        public override string TableName { get; set; } = "`sc_notify_user`";
        ...
        public Sc_notify_userMO(MySqlDatabase database) : base(database) { }
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name = "connectionStringName">配置文件.config中定义的连接字符串名称</param>
        public Sc_notify_userMO(string connectionStringName = null) : base(connectionStringName) { }
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="connectionString">数据库连接字符串，如server=192.168.1.1;database=testdb;uid=root;pwd=root</param>
        /// <param name="commandTimeout">CommandTimeout时间</param>
        public Sc_notify_userMO(string connectionString, int commandTimeout) : base(connectionString, commandTimeout) { }
        ...
        public override int Add(Sc_notify_userEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
        {
            RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
            return Database.ExecSqlNonQuery(sql_, paras_, tm_);
        }
        public override async Task<int> AddAsync(Sc_notify_userEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
        {
            RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
            return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
        }
        private void RepairAddData(Sc_notify_userEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
        {
        ...
        public int AddByBatch(IEnumerable<Sc_notify_userEO> items, int batchCount, TransactionManager tm_ = null)
        {
            var ret = 0;
        ...
        public async Task<int> AddByBatchAsync(IEnumerable<Sc_notify_userEO> items, int batchCount, TransactionManager tm_ = null)
        {
            var ret = 0;
            foreach (var sql in BuildAddBatchSql(items, batchCount))
            {
        ...
        private IEnumerable<string> BuildAddBatchSql(IEnumerable<Sc_notify_userEO> items, int batchCount)
        {
            var count = 0;
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>受影响的行数</return>
        public int Remove(Sc_notify_userEO item, TransactionManager tm_ = null)
        {
            return RemoveByPK(item.UserID, item.NotifyID, tm_);
        }
        public async Task<int> RemoveAsync(Sc_notify_userEO item, TransactionManager tm_ = null)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>受影响的行数</return>
        public int Put(Sc_notify_userEO item, TransactionManager tm_ = null)
        {
            RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
            return Database.ExecSqlNonQuery(sql_, paras_, tm_);
        }
        public async Task<int> PutAsync(Sc_notify_userEO item, TransactionManager tm_ = null)
        {
            RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
            return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
        }
        private void RepairPutData(Sc_notify_userEO item, out string sql_, out List<MySqlParameter> paras_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>受影响的行数</return>
        public int Put(IEnumerable<Sc_notify_userEO> items, TransactionManager tm_ = null)
        {
            int ret = 0;
            foreach (var item in items)
            {
        ...
        public async Task<int> PutAsync(IEnumerable<Sc_notify_userEO> items, TransactionManager tm_ = null)
        {
            int ret = 0;
            foreach (var item in items)
            {
        ...
        public bool Set(Sc_notify_userEO item, TransactionManager tm = null)
        {
            bool ret = true;
        ...
        public async Task<bool> SetAsync(Sc_notify_userEO item, TransactionManager tm = null)
        {
            bool ret = true;
            if (GetByPK(item.UserID, item.NotifyID) == null)
            {
        ...
        /// <return></return>
        public Sc_notify_userEO GetByPK(string userID, string notifyID, TransactionManager tm_ = null, bool isForUpdate_ = false)
        {
            RepairGetByPKData(userID, notifyID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
            return Database.ExecSqlSingle(sql_, paras_, tm_, Sc_notify_userEO.MapDataReader);
        }
        public async Task<Sc_notify_userEO> GetByPKAsync(string userID, string notifyID, TransactionManager tm_ = null, bool isForUpdate_ = false)
        {
            RepairGetByPKData(userID, notifyID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
            return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Sc_notify_userEO.MapDataReader);
        }
        private void RepairGetByPKData(string userID, string notifyID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
        ...
        public List<Sc_notify_userEO> GetByNotifyID(string notifyID)
        {
            return GetByNotifyID(notifyID, 0, string.Empty, null);
        }
        public async Task<List<Sc_notify_userEO>> GetByNotifyIDAsync(string notifyID)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByNotifyID(string notifyID, TransactionManager tm_)
        {
            return GetByNotifyID(notifyID, 0, string.Empty, tm_);
        }
        public async Task<List<Sc_notify_userEO>> GetByNotifyIDAsync(string notifyID, TransactionManager tm_)
        {
        ...
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByNotifyID(string notifyID, int top_)
        {
            return GetByNotifyID(notifyID, top_, string.Empty, null);
        }
        public async Task<List<Sc_notify_userEO>> GetByNotifyIDAsync(string notifyID, int top_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByNotifyID(string notifyID, int top_, TransactionManager tm_)
        {
            return GetByNotifyID(notifyID, top_, string.Empty, tm_);
        }
        public async Task<List<Sc_notify_userEO>> GetByNotifyIDAsync(string notifyID, int top_, TransactionManager tm_)
        {
        ...
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByNotifyID(string notifyID, string sort_)
        {
            return GetByNotifyID(notifyID, 0, sort_, null);
        }
        public async Task<List<Sc_notify_userEO>> GetByNotifyIDAsync(string notifyID, string sort_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByNotifyID(string notifyID, string sort_, TransactionManager tm_)
        {
            return GetByNotifyID(notifyID, 0, sort_, tm_);
        }
        public async Task<List<Sc_notify_userEO>> GetByNotifyIDAsync(string notifyID, string sort_, TransactionManager tm_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByNotifyID(string notifyID, int top_, string sort_, TransactionManager tm_)
        {
            var sql_ = BuildSelectSQL("`NotifyID` = @NotifyID", top_, sort_);
            var paras_ = new List<MySqlParameter>();
            paras_.Add(Database.CreateInParameter("@NotifyID", notifyID, MySqlDbType.VarChar));
            return Database.ExecSqlList(sql_, paras_, tm_, Sc_notify_userEO.MapDataReader);
        }
        public async Task<List<Sc_notify_userEO>> GetByNotifyIDAsync(string notifyID, int top_, string sort_, TransactionManager tm_)
        {
            var sql_ = BuildSelectSQL("`NotifyID` = @NotifyID", top_, sort_);
            var paras_ = new List<MySqlParameter>();
            paras_.Add(Database.CreateInParameter("@NotifyID", notifyID, MySqlDbType.VarChar));
            return await Database.ExecSqlListAsync(sql_, paras_, tm_, Sc_notify_userEO.MapDataReader);
        }
        ...
        /// /// <param name = "userID">用户编码</param>
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByUserID(string userID)
        {
            return GetByUserID(userID, 0, string.Empty, null);
        }
        public async Task<List<Sc_notify_userEO>> GetByUserIDAsync(string userID)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByUserID(string userID, TransactionManager tm_)
        {
            return GetByUserID(userID, 0, string.Empty, tm_);
        }
        public async Task<List<Sc_notify_userEO>> GetByUserIDAsync(string userID, TransactionManager tm_)
        {
        ...
        /// <param name = "top_">获取行数</param>
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByUserID(string userID, int top_)
        {
            return GetByUserID(userID, top_, string.Empty, null);
        }
        public async Task<List<Sc_notify_userEO>> GetByUserIDAsync(string userID, int top_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByUserID(string userID, int top_, TransactionManager tm_)
        {
            return GetByUserID(userID, top_, string.Empty, tm_);
        }
        public async Task<List<Sc_notify_userEO>> GetByUserIDAsync(string userID, int top_, TransactionManager tm_)
        {
        ...
        /// <param name = "sort_">排序表达式</param>
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByUserID(string userID, string sort_)
        {
            return GetByUserID(userID, 0, sort_, null);
        }
        public async Task<List<Sc_notify_userEO>> GetByUserIDAsync(string userID, string sort_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByUserID(string userID, string sort_, TransactionManager tm_)
        {
            return GetByUserID(userID, 0, sort_, tm_);
        }
        public async Task<List<Sc_notify_userEO>> GetByUserIDAsync(string userID, string sort_, TransactionManager tm_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<Sc_notify_userEO> GetByUserID(string userID, int top_, string sort_, TransactionManager tm_)
        {
        ...
        public async Task<List<Sc_notify_userEO>> GetByUserIDAsync(string userID, int top_, string sort_, TransactionManager tm_)
        {
            var sql_ = BuildSelectSQL("`UserID` = @UserID", top_, sort_);
            var paras_ = new List<MySqlParameter>();
            paras_.Add(Database.CreateInParameter("@UserID", userID, MySqlDbType.VarChar));
