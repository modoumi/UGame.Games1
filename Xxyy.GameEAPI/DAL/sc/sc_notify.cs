...
namespace Xxyy.DAL
{
    ...
    public class Sc_notifyMO : MySqlTableMO<Sc_notifyEO>
    {
        ...
        {
            RepairGetByPKData(notifyID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string notifyID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
