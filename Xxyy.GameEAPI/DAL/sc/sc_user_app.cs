...
namespace Xxyy.DAL
{
    ...
    public class Sc_user_appMO : MySqlTableMO<Sc_user_appEO>
    {
        ...
        {
            RepairGetByPKData(userID, appID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string userID, string appID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
