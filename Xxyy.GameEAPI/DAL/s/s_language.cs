...
namespace Xxyy.DAL
{
    ...
    public class S_languageMO : MySqlTableMO<S_languageEO>
    {
        ...
        {
            RepairGetByPKData(langID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string langID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
