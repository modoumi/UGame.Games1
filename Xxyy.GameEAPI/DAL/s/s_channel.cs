...
namespace Xxyy.DAL
{
    ...
    public class S_channelMO : MySqlTableMO<S_channelEO>
    {
        ...
        {
            RepairGetByPKData(channelID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string channelID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
