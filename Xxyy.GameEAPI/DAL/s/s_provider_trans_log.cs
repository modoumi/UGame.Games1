...
namespace Xxyy.DAL
{
    ...
    public class S_provider_trans_logMO : MySqlTableMO<S_provider_trans_logEO>
    {
        ...
        {
            RepairGetByPKData(transLogID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string transLogID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
