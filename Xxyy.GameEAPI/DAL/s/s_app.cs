...
namespace Xxyy.DAL
{
    ...
    public class S_appMO : MySqlTableMO<S_appEO>
    {
        ...
        {
            RepairGetByPKData(appID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string appID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
