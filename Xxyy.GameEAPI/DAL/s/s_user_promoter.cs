...
namespace Xxyy.DAL
{
    ...
    public class S_user_promoterMO : MySqlTableMO<S_user_promoterEO>
    {
        ...
        {
            RepairGetByPKData(pUserID, iUserID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string pUserID, string iUserID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
