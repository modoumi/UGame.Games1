...
namespace Xxyy.DAL
{
    ...
    public class S_app_langMO : MySqlTableMO<S_app_langEO>
    {
        ...
        {
            RepairGetByPKData(appID, langID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string appID, string langID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
