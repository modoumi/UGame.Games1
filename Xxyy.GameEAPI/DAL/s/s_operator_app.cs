...
namespace Xxyy.DAL
{
    ...
    public class S_operator_appMO : MySqlTableMO<S_operator_appEO>
    {
        ...
        /// 按字段删除
        /// </summary>
        /// /// <param name = "effectStatus">游戏入口效果标识 0-无 1-有</param>
        /// <param name="tm_">事务管理对象</param>
        ...
        {
            RepairGetByPKData(appID, operatorID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string appID, string operatorID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
