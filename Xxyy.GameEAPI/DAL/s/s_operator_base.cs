...
namespace Xxyy.DAL
{
    ...
    public class S_operator_baseMO : MySqlTableMO<S_operator_baseEO>
    {
        ...
        {
            RepairGetByPKData(operatorBaseID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string operatorBaseID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
