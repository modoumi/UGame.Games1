...
namespace Xxyy.DAL
{
    ...
    public class S_user_dayMO : MySqlTableMO<S_user_dayEO>
    {
        ...
        {
            RepairGetByPKData(dayID, userID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(DateTime dayID, string userID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
