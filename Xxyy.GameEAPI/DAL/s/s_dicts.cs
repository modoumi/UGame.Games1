...
namespace Xxyy.DAL
{
    ...
    /// </summary>
    [DataContract]
    public class S_dictsEO : IRowMapper<S_dictsEO>
    {
        /// <summary>
        /// 构造函数 
        /// </summary>
        ...
        /// <return>实体对象</return>
        public S_dictsEO MapRow(IDataReader reader)
        {
        ...
        /// <param name = "reader">只进结果集流</param>
        /// <return>实体对象</return>
        public static S_dictsEO MapDataReader(IDataReader reader)
        {
            S_dictsEO ret = new S_dictsEO();
    ...
    /// 【表 s_dicts 的操作类】
    /// </summary>
    public class S_dictsMO : MySqlTableMO<S_dictsEO>
    {
        /// <summary>
        /// 表名
        /// </summary>
        public override string TableName { get; set; } = "`s_dicts`";
        ...
        public S_dictsMO(MySqlDatabase database) : base(database) { }
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name = "connectionStringName">配置文件.config中定义的连接字符串名称</param>
        public S_dictsMO(string connectionStringName = null) : base(connectionStringName) { }
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="connectionString">数据库连接字符串，如server=192.168.1.1;database=testdb;uid=root;pwd=root</param>
        /// <param name="commandTimeout">CommandTimeout时间</param>
        public S_dictsMO(string connectionString, int commandTimeout) : base(connectionString, commandTimeout) { }
        ...
        public override int Add(S_dictsEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
        {
            RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
            return Database.ExecSqlNonQuery(sql_, paras_, tm_);
        }
        public override async Task<int> AddAsync(S_dictsEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
        {
            RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
            return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
        }
        private void RepairAddData(S_dictsEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
        {
        ...
        public int AddByBatch(IEnumerable<S_dictsEO> items, int batchCount, TransactionManager tm_ = null)
        {
            var ret = 0;
        ...
        public async Task<int> AddByBatchAsync(IEnumerable<S_dictsEO> items, int batchCount, TransactionManager tm_ = null)
        {
            var ret = 0;
            foreach (var sql in BuildAddBatchSql(items, batchCount))
            {
        ...
        private IEnumerable<string> BuildAddBatchSql(IEnumerable<S_dictsEO> items, int batchCount)
        {
            var count = 0;
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>受影响的行数</return>
        public int Remove(S_dictsEO item, TransactionManager tm_ = null)
        {
            return RemoveByPK(item.DictID, tm_);
        }
        public async Task<int> RemoveAsync(S_dictsEO item, TransactionManager tm_ = null)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>受影响的行数</return>
        public int Put(S_dictsEO item, TransactionManager tm_ = null)
        {
            RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
            return Database.ExecSqlNonQuery(sql_, paras_, tm_);
        }
        public async Task<int> PutAsync(S_dictsEO item, TransactionManager tm_ = null)
        {
            RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
            return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
        }
        private void RepairPutData(S_dictsEO item, out string sql_, out List<MySqlParameter> paras_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>受影响的行数</return>
        public int Put(IEnumerable<S_dictsEO> items, TransactionManager tm_ = null)
        {
            int ret = 0;
            foreach (var item in items)
            {
        ...
        public async Task<int> PutAsync(IEnumerable<S_dictsEO> items, TransactionManager tm_ = null)
        {
            int ret = 0;
            foreach (var item in items)
            {
        ...
        public bool Set(S_dictsEO item, TransactionManager tm = null)
        {
            bool ret = true;
        ...
        public async Task<bool> SetAsync(S_dictsEO item, TransactionManager tm = null)
        {
            bool ret = true;
            if (GetByPK(item.DictID) == null)
            {
        ...
        /// <return></return>
        public S_dictsEO GetByPK(string dictID, TransactionManager tm_ = null, bool isForUpdate_ = false)
        {
            RepairGetByPKData(dictID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
            return Database.ExecSqlSingle(sql_, paras_, tm_, S_dictsEO.MapDataReader);
        }
        public async Task<S_dictsEO> GetByPKAsync(string dictID, TransactionManager tm_ = null, bool isForUpdate_ = false)
        {
            RepairGetByPKData(dictID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
            return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, S_dictsEO.MapDataReader);
        }
        private void RepairGetByPKData(string dictID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
        ...
        public List<S_dictsEO> GetByCategory(string category)
        {
            return GetByCategory(category, 0, string.Empty, null);
        }
        public async Task<List<S_dictsEO>> GetByCategoryAsync(string category)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByCategory(string category, TransactionManager tm_)
        {
            return GetByCategory(category, 0, string.Empty, tm_);
        }
        public async Task<List<S_dictsEO>> GetByCategoryAsync(string category, TransactionManager tm_)
        {
        ...
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByCategory(string category, int top_)
        {
            return GetByCategory(category, top_, string.Empty, null);
        }
        public async Task<List<S_dictsEO>> GetByCategoryAsync(string category, int top_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByCategory(string category, int top_, TransactionManager tm_)
        {
            return GetByCategory(category, top_, string.Empty, tm_);
        }
        public async Task<List<S_dictsEO>> GetByCategoryAsync(string category, int top_, TransactionManager tm_)
        {
        ...
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByCategory(string category, string sort_)
        {
            return GetByCategory(category, 0, sort_, null);
        }
        public async Task<List<S_dictsEO>> GetByCategoryAsync(string category, string sort_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByCategory(string category, string sort_, TransactionManager tm_)
        {
            return GetByCategory(category, 0, sort_, tm_);
        }
        public async Task<List<S_dictsEO>> GetByCategoryAsync(string category, string sort_, TransactionManager tm_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByCategory(string category, int top_, string sort_, TransactionManager tm_)
        {
            var sql_ = BuildSelectSQL(category != null ? "`Category` = @Category" : "`Category` IS NULL", top_, sort_);
            var paras_ = new List<MySqlParameter>();
            if (category != null)
                paras_.Add(Database.CreateInParameter("@Category", category, MySqlDbType.VarChar));
            return Database.ExecSqlList(sql_, paras_, tm_, S_dictsEO.MapDataReader);
        }
        public async Task<List<S_dictsEO>> GetByCategoryAsync(string category, int top_, string sort_, TransactionManager tm_)
        {
            var sql_ = BuildSelectSQL(category != null ? "`Category` = @Category" : "`Category` IS NULL", top_, sort_);
            var paras_ = new List<MySqlParameter>();
            if (category != null)
                paras_.Add(Database.CreateInParameter("@Category", category, MySqlDbType.VarChar));
            return await Database.ExecSqlListAsync(sql_, paras_, tm_, S_dictsEO.MapDataReader);
        }
        ...
        /// /// <param name = "title">描述</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByTitle(string title)
        {
            return GetByTitle(title, 0, string.Empty, null);
        }
        public async Task<List<S_dictsEO>> GetByTitleAsync(string title)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByTitle(string title, TransactionManager tm_)
        {
            return GetByTitle(title, 0, string.Empty, tm_);
        }
        public async Task<List<S_dictsEO>> GetByTitleAsync(string title, TransactionManager tm_)
        {
        ...
        /// <param name = "top_">获取行数</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByTitle(string title, int top_)
        {
            return GetByTitle(title, top_, string.Empty, null);
        }
        public async Task<List<S_dictsEO>> GetByTitleAsync(string title, int top_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByTitle(string title, int top_, TransactionManager tm_)
        {
            return GetByTitle(title, top_, string.Empty, tm_);
        }
        public async Task<List<S_dictsEO>> GetByTitleAsync(string title, int top_, TransactionManager tm_)
        {
        ...
        /// <param name = "sort_">排序表达式</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByTitle(string title, string sort_)
        {
            return GetByTitle(title, 0, sort_, null);
        }
        public async Task<List<S_dictsEO>> GetByTitleAsync(string title, string sort_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByTitle(string title, string sort_, TransactionManager tm_)
        {
            return GetByTitle(title, 0, sort_, tm_);
        }
        public async Task<List<S_dictsEO>> GetByTitleAsync(string title, string sort_, TransactionManager tm_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByTitle(string title, int top_, string sort_, TransactionManager tm_)
        {
        ...
        public async Task<List<S_dictsEO>> GetByTitleAsync(string title, int top_, string sort_, TransactionManager tm_)
        {
            var sql_ = BuildSelectSQL(title != null ? "`Title` = @Title" : "`Title` IS NULL", top_, sort_);
            var paras_ = new List<MySqlParameter>();
            if (title != null)
        ...
        /// /// <param name = "type">类型0-系统1-用户定义</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByType(int type)
        {
            return GetByType(type, 0, string.Empty, null);
        }
        public async Task<List<S_dictsEO>> GetByTypeAsync(int type)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByType(int type, TransactionManager tm_)
        {
            return GetByType(type, 0, string.Empty, tm_);
        }
        public async Task<List<S_dictsEO>> GetByTypeAsync(int type, TransactionManager tm_)
        {
        ...
        /// <param name = "top_">获取行数</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByType(int type, int top_)
        {
            return GetByType(type, top_, string.Empty, null);
        }
        public async Task<List<S_dictsEO>> GetByTypeAsync(int type, int top_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByType(int type, int top_, TransactionManager tm_)
        {
            return GetByType(type, top_, string.Empty, tm_);
        }
        public async Task<List<S_dictsEO>> GetByTypeAsync(int type, int top_, TransactionManager tm_)
        {
        ...
        /// <param name = "sort_">排序表达式</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByType(int type, string sort_)
        {
            return GetByType(type, 0, sort_, null);
        }
        public async Task<List<S_dictsEO>> GetByTypeAsync(int type, string sort_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByType(int type, string sort_, TransactionManager tm_)
        {
            return GetByType(type, 0, sort_, tm_);
        }
        public async Task<List<S_dictsEO>> GetByTypeAsync(int type, string sort_, TransactionManager tm_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByType(int type, int top_, string sort_, TransactionManager tm_)
        {
        ...
        public async Task<List<S_dictsEO>> GetByTypeAsync(int type, int top_, string sort_, TransactionManager tm_)
        {
            var sql_ = BuildSelectSQL("`Type` = @Type", top_, sort_);
            var paras_ = new List<MySqlParameter>();
            paras_.Add(Database.CreateInParameter("@Type", type, MySqlDbType.Int32));
        ...
        /// /// <param name = "valueValue">值Value</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByValue(string valueValue)
        {
            return GetByValue(valueValue, 0, string.Empty, null);
        }
        public async Task<List<S_dictsEO>> GetByValueAsync(string valueValue)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByValue(string valueValue, TransactionManager tm_)
        {
            return GetByValue(valueValue, 0, string.Empty, tm_);
        }
        public async Task<List<S_dictsEO>> GetByValueAsync(string valueValue, TransactionManager tm_)
        {
        ...
        /// <param name = "top_">获取行数</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByValue(string valueValue, int top_)
        {
            return GetByValue(valueValue, top_, string.Empty, null);
        }
        public async Task<List<S_dictsEO>> GetByValueAsync(string valueValue, int top_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByValue(string valueValue, int top_, TransactionManager tm_)
        {
            return GetByValue(valueValue, top_, string.Empty, tm_);
        }
        public async Task<List<S_dictsEO>> GetByValueAsync(string valueValue, int top_, TransactionManager tm_)
        {
        ...
        /// <param name = "sort_">排序表达式</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByValue(string valueValue, string sort_)
        {
            return GetByValue(valueValue, 0, sort_, null);
        }
        public async Task<List<S_dictsEO>> GetByValueAsync(string valueValue, string sort_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByValue(string valueValue, string sort_, TransactionManager tm_)
        {
            return GetByValue(valueValue, 0, sort_, tm_);
        }
        public async Task<List<S_dictsEO>> GetByValueAsync(string valueValue, string sort_, TransactionManager tm_)
        {
        ...
        /// <param name="tm_">事务管理对象</param>
        /// <return>实体对象集合</return>
        public List<S_dictsEO> GetByValue(string valueValue, int top_, string sort_, TransactionManager tm_)
        {
        ...
        public async Task<List<S_dictsEO>> GetByValueAsync(string valueValue, int top_, string sort_, TransactionManager tm_)
        {
            var sql_ = BuildSelectSQL(valueValue != null ? "`Value` = @Value" : "`Value` IS NULL", top_, sort_);
            var paras_ = new List<MySqlParameter>();
            if (valueValue != null)
