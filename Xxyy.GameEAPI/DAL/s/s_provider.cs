...
namespace Xxyy.DAL
{
    ...
    public class S_providerMO : MySqlTableMO<S_providerEO>
    {
        ...
        {
            RepairGetByPKData(providerID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string providerID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
