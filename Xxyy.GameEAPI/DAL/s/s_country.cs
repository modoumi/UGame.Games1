...
namespace Xxyy.DAL
{
    ...
    public class S_countryMO : MySqlTableMO<S_countryEO>
    {
        ...
        {
            RepairGetByPKData(countryID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
        ...
        private void RepairGetByPKData(string countryID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
        {
