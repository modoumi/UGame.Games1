...
namespace Fortune_big.DAL
{
	...
	/// <summary>
	/// 所有奖池权重
	/// 【表 big_config_weight_t 的实体类】
	/// </summary>
	[DataContract]
	[Obsolete]
	public class Big_config_weight_tEO : IRowMapper<Big_config_weight_tEO>
	{
		/// <summary>
		/// 构造函数 
		/// </summary>
		public Big_config_weight_tEO()
		{
			this.Weight_Main = 0;
			this.Weight_SM = 0;
			this.Multip = 0f;
		...
		/// <return>实体对象</return>
		public Big_config_weight_tEO MapRow(IDataReader reader)
		{
		...
		/// <param name = "reader">只进结果集流</param>
		/// <return>实体对象</return>
		public static Big_config_weight_tEO MapDataReader(IDataReader reader)
		{
		    Big_config_weight_tEO ret = new Big_config_weight_tEO();
	...
	/// <summary>
	/// 所有奖池权重
	/// 【表 big_config_weight_t 的操作类】
	/// </summary>
	[Obsolete]
	public class Big_config_weight_tMO : MySqlTableMO<Big_config_weight_tEO>
	{
		/// <summary>
		/// 表名
		/// </summary>
	    public override string TableName { get; set; } = "`big_config_weight_t`";
		...
		public Big_config_weight_tMO(MySqlDatabase database) : base(database) { }
		/// <summary>
		/// 构造函数
		/// </summary>
		/// <param name = "connectionStringName">配置文件.config中定义的连接字符串名称</param>
		public Big_config_weight_tMO(string connectionStringName = null) : base(connectionStringName) { }
	    /// <summary>
	    /// 构造函数
	    /// </summary>
	    /// <param name="connectionString">数据库连接字符串，如server=192.168.1.1;database=testdb;uid=root;pwd=root</param>
	    /// <param name="commandTimeout">CommandTimeout时间</param>
	    public Big_config_weight_tMO(string connectionString, int commandTimeout) : base(connectionString, commandTimeout) { }
		...
		public override int Add(Big_config_weight_tEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_); 
		}
		public override async Task<int> AddAsync(Big_config_weight_tEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_); 
		}
	    private void RepairAddData(Big_config_weight_tEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		public int AddByBatch(IEnumerable<Big_config_weight_tEO> items, int batchCount, TransactionManager tm_ = null)
		{
			var ret = 0;
	    ...
	    public async Task<int> AddByBatchAsync(IEnumerable<Big_config_weight_tEO> items, int batchCount, TransactionManager tm_ = null)
	    {
	        var ret = 0;
	        foreach (var sql in BuildAddBatchSql(items, batchCount))
	        {
	    ...
	    private IEnumerable<string> BuildAddBatchSql(IEnumerable<Big_config_weight_tEO> items, int batchCount)
		{
			var count = 0;
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Remove(Big_config_weight_tEO item, TransactionManager tm_ = null)
		{
			return RemoveByPK(item.TID, tm_);
		}
		public async Task<int> RemoveAsync(Big_config_weight_tEO item, TransactionManager tm_ = null)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(Big_config_weight_tEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutAsync(Big_config_weight_tEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutData(Big_config_weight_tEO item, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(IEnumerable<Big_config_weight_tEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public async Task<int> PutAsync(IEnumerable<Big_config_weight_tEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public bool Set(Big_config_weight_tEO item, TransactionManager tm = null)
		{
			bool ret = true;
		...
		public async Task<bool> SetAsync(Big_config_weight_tEO item, TransactionManager tm = null)
		{
			bool ret = true;
			if(GetByPK(item.TID) == null)
			{
		...
		/// <return></return>
		public Big_config_weight_tEO GetByPK(int tID, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(tID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return Database.ExecSqlSingle(sql_, paras_, tm_, Big_config_weight_tEO.MapDataReader);
		}
		public async Task<Big_config_weight_tEO> GetByPKAsync(int tID, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(tID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Big_config_weight_tEO.MapDataReader);
		}
		...
		public List<Big_config_weight_tEO> GetByWeight_Main(int weight_Main)
		{
			return GetByWeight_Main(weight_Main, 0, string.Empty, null);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_MainAsync(int weight_Main)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_Main(int weight_Main, TransactionManager tm_)
		{
			return GetByWeight_Main(weight_Main, 0, string.Empty, tm_);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_MainAsync(int weight_Main, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_Main(int weight_Main, int top_)
		{
			return GetByWeight_Main(weight_Main, top_, string.Empty, null);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_MainAsync(int weight_Main, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_Main(int weight_Main, int top_, TransactionManager tm_)
		{
			return GetByWeight_Main(weight_Main, top_, string.Empty, tm_);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_MainAsync(int weight_Main, int top_, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_Main(int weight_Main, string sort_)
		{
			return GetByWeight_Main(weight_Main, 0, sort_, null);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_MainAsync(int weight_Main, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_Main(int weight_Main, string sort_, TransactionManager tm_)
		{
			return GetByWeight_Main(weight_Main, 0, sort_, tm_);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_MainAsync(int weight_Main, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_Main(int weight_Main, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`Weight_Main` = @Weight_Main", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@Weight_Main", weight_Main, MySqlDbType.Int32));
			return Database.ExecSqlList(sql_, paras_, tm_, Big_config_weight_tEO.MapDataReader);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_MainAsync(int weight_Main, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`Weight_Main` = @Weight_Main", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@Weight_Main", weight_Main, MySqlDbType.Int32));
			return await Database.ExecSqlListAsync(sql_, paras_, tm_, Big_config_weight_tEO.MapDataReader);
		}
		...
		/// /// <param name = "weight_SM">特殊玩法权重</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_SM(int weight_SM)
		{
			return GetByWeight_SM(weight_SM, 0, string.Empty, null);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_SMAsync(int weight_SM)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_SM(int weight_SM, TransactionManager tm_)
		{
			return GetByWeight_SM(weight_SM, 0, string.Empty, tm_);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_SMAsync(int weight_SM, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_SM(int weight_SM, int top_)
		{
			return GetByWeight_SM(weight_SM, top_, string.Empty, null);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_SMAsync(int weight_SM, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_SM(int weight_SM, int top_, TransactionManager tm_)
		{
			return GetByWeight_SM(weight_SM, top_, string.Empty, tm_);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_SMAsync(int weight_SM, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_SM(int weight_SM, string sort_)
		{
			return GetByWeight_SM(weight_SM, 0, sort_, null);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_SMAsync(int weight_SM, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_SM(int weight_SM, string sort_, TransactionManager tm_)
		{
			return GetByWeight_SM(weight_SM, 0, sort_, tm_);
		}
		public async Task<List<Big_config_weight_tEO>> GetByWeight_SMAsync(int weight_SM, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByWeight_SM(int weight_SM, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Big_config_weight_tEO>> GetByWeight_SMAsync(int weight_SM, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`Weight_SM` = @Weight_SM", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@Weight_SM", weight_SM, MySqlDbType.Int32));
		...
		/// /// <param name = "multip">倍率</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByMultip(float multip)
		{
			return GetByMultip(multip, 0, string.Empty, null);
		}
		public async Task<List<Big_config_weight_tEO>> GetByMultipAsync(float multip)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByMultip(float multip, TransactionManager tm_)
		{
			return GetByMultip(multip, 0, string.Empty, tm_);
		}
		public async Task<List<Big_config_weight_tEO>> GetByMultipAsync(float multip, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByMultip(float multip, int top_)
		{
			return GetByMultip(multip, top_, string.Empty, null);
		}
		public async Task<List<Big_config_weight_tEO>> GetByMultipAsync(float multip, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByMultip(float multip, int top_, TransactionManager tm_)
		{
			return GetByMultip(multip, top_, string.Empty, tm_);
		}
		public async Task<List<Big_config_weight_tEO>> GetByMultipAsync(float multip, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByMultip(float multip, string sort_)
		{
			return GetByMultip(multip, 0, sort_, null);
		}
		public async Task<List<Big_config_weight_tEO>> GetByMultipAsync(float multip, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByMultip(float multip, string sort_, TransactionManager tm_)
		{
			return GetByMultip(multip, 0, sort_, tm_);
		}
		public async Task<List<Big_config_weight_tEO>> GetByMultipAsync(float multip, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Big_config_weight_tEO> GetByMultip(float multip, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Big_config_weight_tEO>> GetByMultipAsync(float multip, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`Multip` = @Multip", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@Multip", multip, MySqlDbType.Float));
