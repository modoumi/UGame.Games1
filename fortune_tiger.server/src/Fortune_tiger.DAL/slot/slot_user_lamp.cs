...
namespace Fortune_tiger.DAL
{
	...
	/// <summary>
	/// 跑马灯
	/// 【表 slot_user_lamp 的实体类】
	/// </summary>
	[DataContract]
	[Obsolete]
	public class Slot_user_lampEO : IRowMapper<Slot_user_lampEO>
	{
		/// <summary>
		/// 构造函数 
		/// </summary>
		public Slot_user_lampEO()
		{
			this.PlayerName = "0";
			this.Reward = 0;
		...
		/// <return>实体对象</return>
		public Slot_user_lampEO MapRow(IDataReader reader)
		{
		...
		/// <param name = "reader">只进结果集流</param>
		/// <return>实体对象</return>
		public static Slot_user_lampEO MapDataReader(IDataReader reader)
		{
		    Slot_user_lampEO ret = new Slot_user_lampEO();
	...
	/// <summary>
	/// 跑马灯
	/// 【表 slot_user_lamp 的操作类】
	/// </summary>
	[Obsolete]
	public class Slot_user_lampMO : MySqlTableMO<Slot_user_lampEO>
	{
		/// <summary>
		/// 表名
		/// </summary>
	    public override string TableName { get; set; } = "`slot_user_lamp`";
		...
		public Slot_user_lampMO(MySqlDatabase database) : base(database) { }
		/// <summary>
		/// 构造函数
		/// </summary>
		/// <param name = "connectionStringName">配置文件.config中定义的连接字符串名称</param>
		public Slot_user_lampMO(string connectionStringName = null) : base(connectionStringName) { }
	    /// <summary>
	    /// 构造函数
	    /// </summary>
	    /// <param name="connectionString">数据库连接字符串，如server=192.168.1.1;database=testdb;uid=root;pwd=root</param>
	    /// <param name="commandTimeout">CommandTimeout时间</param>
	    public Slot_user_lampMO(string connectionString, int commandTimeout) : base(connectionString, commandTimeout) { }
		...
		public override int Add(Slot_user_lampEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			item.LampID = Database.ExecSqlScalar<int>(sql_, paras_, tm_); 
			return 1;
		}
		public override async Task<int> AddAsync(Slot_user_lampEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			item.LampID = await Database.ExecSqlScalarAsync<int>(sql_, paras_, tm_); 
	        return 1;
		}
	    private void RepairAddData(Slot_user_lampEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		public int AddByBatch(IEnumerable<Slot_user_lampEO> items, int batchCount, TransactionManager tm_ = null)
		{
			var ret = 0;
	    ...
	    public async Task<int> AddByBatchAsync(IEnumerable<Slot_user_lampEO> items, int batchCount, TransactionManager tm_ = null)
	    {
	        var ret = 0;
	        foreach (var sql in BuildAddBatchSql(items, batchCount))
	        {
	    ...
	    private IEnumerable<string> BuildAddBatchSql(IEnumerable<Slot_user_lampEO> items, int batchCount)
		{
			var count = 0;
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Remove(Slot_user_lampEO item, TransactionManager tm_ = null)
		{
			return RemoveByPK(item.LampID, item.AppID, tm_);
		}
		public async Task<int> RemoveAsync(Slot_user_lampEO item, TransactionManager tm_ = null)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(Slot_user_lampEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutAsync(Slot_user_lampEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutData(Slot_user_lampEO item, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(IEnumerable<Slot_user_lampEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public async Task<int> PutAsync(IEnumerable<Slot_user_lampEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public bool Set(Slot_user_lampEO item, TransactionManager tm = null)
		{
			bool ret = true;
		...
		public async Task<bool> SetAsync(Slot_user_lampEO item, TransactionManager tm = null)
		{
			bool ret = true;
			if(GetByPK(item.LampID, item.AppID) == null)
			{
		...
		/// <return></return>
		public Slot_user_lampEO GetByPK(int lampID, string appID, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(lampID, appID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return Database.ExecSqlSingle(sql_, paras_, tm_, Slot_user_lampEO.MapDataReader);
		}
		public async Task<Slot_user_lampEO> GetByPKAsync(int lampID, string appID, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(lampID, appID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Slot_user_lampEO.MapDataReader);
		}
		...
		public List<Slot_user_lampEO> GetByLampID(int lampID)
		{
			return GetByLampID(lampID, 0, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByLampIDAsync(int lampID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByLampID(int lampID, TransactionManager tm_)
		{
			return GetByLampID(lampID, 0, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByLampIDAsync(int lampID, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByLampID(int lampID, int top_)
		{
			return GetByLampID(lampID, top_, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByLampIDAsync(int lampID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByLampID(int lampID, int top_, TransactionManager tm_)
		{
			return GetByLampID(lampID, top_, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByLampIDAsync(int lampID, int top_, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByLampID(int lampID, string sort_)
		{
			return GetByLampID(lampID, 0, sort_, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByLampIDAsync(int lampID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByLampID(int lampID, string sort_, TransactionManager tm_)
		{
			return GetByLampID(lampID, 0, sort_, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByLampIDAsync(int lampID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByLampID(int lampID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`LampID` = @LampID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@LampID", lampID, MySqlDbType.Int32));
			return Database.ExecSqlList(sql_, paras_, tm_, Slot_user_lampEO.MapDataReader);
		}
		public async Task<List<Slot_user_lampEO>> GetByLampIDAsync(int lampID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`LampID` = @LampID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@LampID", lampID, MySqlDbType.Int32));
			return await Database.ExecSqlListAsync(sql_, paras_, tm_, Slot_user_lampEO.MapDataReader);
		}
		...
		/// /// <param name = "appID">appid</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByAppID(string appID)
		{
			return GetByAppID(appID, 0, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByAppIDAsync(string appID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByAppID(string appID, TransactionManager tm_)
		{
			return GetByAppID(appID, 0, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByAppIDAsync(string appID, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByAppID(string appID, int top_)
		{
			return GetByAppID(appID, top_, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByAppIDAsync(string appID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByAppID(string appID, int top_, TransactionManager tm_)
		{
			return GetByAppID(appID, top_, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByAppIDAsync(string appID, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByAppID(string appID, string sort_)
		{
			return GetByAppID(appID, 0, sort_, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByAppIDAsync(string appID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByAppID(string appID, string sort_, TransactionManager tm_)
		{
			return GetByAppID(appID, 0, sort_, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByAppIDAsync(string appID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByAppID(string appID, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Slot_user_lampEO>> GetByAppIDAsync(string appID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`AppID` = @AppID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@AppID", appID, MySqlDbType.VarChar));
		...
		/// /// <param name = "operatorID">运营商编码</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByOperatorID(string operatorID)
		{
			return GetByOperatorID(operatorID, 0, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByOperatorIDAsync(string operatorID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByOperatorID(string operatorID, TransactionManager tm_)
		{
			return GetByOperatorID(operatorID, 0, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByOperatorIDAsync(string operatorID, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByOperatorID(string operatorID, int top_)
		{
			return GetByOperatorID(operatorID, top_, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByOperatorIDAsync(string operatorID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByOperatorID(string operatorID, int top_, TransactionManager tm_)
		{
			return GetByOperatorID(operatorID, top_, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByOperatorIDAsync(string operatorID, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByOperatorID(string operatorID, string sort_)
		{
			return GetByOperatorID(operatorID, 0, sort_, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByOperatorIDAsync(string operatorID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByOperatorID(string operatorID, string sort_, TransactionManager tm_)
		{
			return GetByOperatorID(operatorID, 0, sort_, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByOperatorIDAsync(string operatorID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByOperatorID(string operatorID, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Slot_user_lampEO>> GetByOperatorIDAsync(string operatorID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`OperatorID` = @OperatorID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@OperatorID", operatorID, MySqlDbType.VarChar));
		...
		/// /// <param name = "currencyID">货币编码（ISO 4217大写）</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByCurrencyID(string currencyID)
		{
			return GetByCurrencyID(currencyID, 0, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByCurrencyIDAsync(string currencyID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByCurrencyID(string currencyID, TransactionManager tm_)
		{
			return GetByCurrencyID(currencyID, 0, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByCurrencyIDAsync(string currencyID, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByCurrencyID(string currencyID, int top_)
		{
			return GetByCurrencyID(currencyID, top_, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByCurrencyIDAsync(string currencyID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByCurrencyID(string currencyID, int top_, TransactionManager tm_)
		{
			return GetByCurrencyID(currencyID, top_, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByCurrencyIDAsync(string currencyID, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByCurrencyID(string currencyID, string sort_)
		{
			return GetByCurrencyID(currencyID, 0, sort_, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByCurrencyIDAsync(string currencyID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByCurrencyID(string currencyID, string sort_, TransactionManager tm_)
		{
			return GetByCurrencyID(currencyID, 0, sort_, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByCurrencyIDAsync(string currencyID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByCurrencyID(string currencyID, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Slot_user_lampEO>> GetByCurrencyIDAsync(string currencyID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`CurrencyID` = @CurrencyID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@CurrencyID", currencyID, MySqlDbType.VarChar));
		...
		/// /// <param name = "playerName">中奖昵称</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByPlayerName(string playerName)
		{
			return GetByPlayerName(playerName, 0, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByPlayerNameAsync(string playerName)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByPlayerName(string playerName, TransactionManager tm_)
		{
			return GetByPlayerName(playerName, 0, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByPlayerNameAsync(string playerName, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByPlayerName(string playerName, int top_)
		{
			return GetByPlayerName(playerName, top_, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByPlayerNameAsync(string playerName, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByPlayerName(string playerName, int top_, TransactionManager tm_)
		{
			return GetByPlayerName(playerName, top_, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByPlayerNameAsync(string playerName, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByPlayerName(string playerName, string sort_)
		{
			return GetByPlayerName(playerName, 0, sort_, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByPlayerNameAsync(string playerName, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByPlayerName(string playerName, string sort_, TransactionManager tm_)
		{
			return GetByPlayerName(playerName, 0, sort_, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByPlayerNameAsync(string playerName, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByPlayerName(string playerName, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Slot_user_lampEO>> GetByPlayerNameAsync(string playerName, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`PlayerName` = @PlayerName", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@PlayerName", playerName, MySqlDbType.VarChar));
		...
		/// /// <param name = "reward">中奖金额</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByReward(long reward)
		{
			return GetByReward(reward, 0, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByRewardAsync(long reward)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByReward(long reward, TransactionManager tm_)
		{
			return GetByReward(reward, 0, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByRewardAsync(long reward, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByReward(long reward, int top_)
		{
			return GetByReward(reward, top_, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByRewardAsync(long reward, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByReward(long reward, int top_, TransactionManager tm_)
		{
			return GetByReward(reward, top_, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByRewardAsync(long reward, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByReward(long reward, string sort_)
		{
			return GetByReward(reward, 0, sort_, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByRewardAsync(long reward, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByReward(long reward, string sort_, TransactionManager tm_)
		{
			return GetByReward(reward, 0, sort_, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByRewardAsync(long reward, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByReward(long reward, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Slot_user_lampEO>> GetByRewardAsync(long reward, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`Reward` = @Reward", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@Reward", reward, MySqlDbType.Int64));
		...
		/// /// <param name = "multip">中奖总倍数</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByMultip(int multip)
		{
			return GetByMultip(multip, 0, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByMultipAsync(int multip)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByMultip(int multip, TransactionManager tm_)
		{
			return GetByMultip(multip, 0, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByMultipAsync(int multip, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByMultip(int multip, int top_)
		{
			return GetByMultip(multip, top_, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByMultipAsync(int multip, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByMultip(int multip, int top_, TransactionManager tm_)
		{
			return GetByMultip(multip, top_, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByMultipAsync(int multip, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByMultip(int multip, string sort_)
		{
			return GetByMultip(multip, 0, sort_, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByMultipAsync(int multip, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByMultip(int multip, string sort_, TransactionManager tm_)
		{
			return GetByMultip(multip, 0, sort_, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByMultipAsync(int multip, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByMultip(int multip, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Slot_user_lampEO>> GetByMultipAsync(int multip, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`Multip` = @Multip", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@Multip", multip, MySqlDbType.Int32));
		...
		/// /// <param name = "recDate">记录时间</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByRecDate(DateTime recDate)
		{
			return GetByRecDate(recDate, 0, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByRecDateAsync(DateTime recDate)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByRecDate(DateTime recDate, TransactionManager tm_)
		{
			return GetByRecDate(recDate, 0, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByRecDateAsync(DateTime recDate, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByRecDate(DateTime recDate, int top_)
		{
			return GetByRecDate(recDate, top_, string.Empty, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByRecDateAsync(DateTime recDate, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByRecDate(DateTime recDate, int top_, TransactionManager tm_)
		{
			return GetByRecDate(recDate, top_, string.Empty, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByRecDateAsync(DateTime recDate, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByRecDate(DateTime recDate, string sort_)
		{
			return GetByRecDate(recDate, 0, sort_, null);
		}
		public async Task<List<Slot_user_lampEO>> GetByRecDateAsync(DateTime recDate, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByRecDate(DateTime recDate, string sort_, TransactionManager tm_)
		{
			return GetByRecDate(recDate, 0, sort_, tm_);
		}
		public async Task<List<Slot_user_lampEO>> GetByRecDateAsync(DateTime recDate, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Slot_user_lampEO> GetByRecDate(DateTime recDate, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Slot_user_lampEO>> GetByRecDateAsync(DateTime recDate, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`RecDate` = @RecDate", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@RecDate", recDate, MySqlDbType.DateTime));
