...
namespace Super_phoenix.DAL
{
	...
	/// <summary>
	/// 线配置表
	/// 【表 gsp_config_line 的实体类】
	/// </summary>
	[DataContract]
	[Obsolete]
	public class Gsp_config_lineEO : IRowMapper<Gsp_config_lineEO>
	{
		/// <summary>
		/// 构造函数 
		/// </summary>
		public Gsp_config_lineEO()
		{
			this.LineNo = 0;
		}
		#region 主键原始值 & 主键集合
		...
		/// <return>实体对象</return>
		public Gsp_config_lineEO MapRow(IDataReader reader)
		{
		...
		/// <param name = "reader">只进结果集流</param>
		/// <return>实体对象</return>
		public static Gsp_config_lineEO MapDataReader(IDataReader reader)
		{
		    Gsp_config_lineEO ret = new Gsp_config_lineEO();
	...
	/// <summary>
	/// 线配置表
	/// 【表 gsp_config_line 的操作类】
	/// </summary>
	[Obsolete]
	public class Gsp_config_lineMO : MySqlTableMO<Gsp_config_lineEO>
	{
		/// <summary>
		/// 表名
		/// </summary>
	    public override string TableName { get; set; } = "`gsp_config_line`";
		...
		public Gsp_config_lineMO(MySqlDatabase database) : base(database) { }
		/// <summary>
		/// 构造函数
		/// </summary>
		/// <param name = "connectionStringName">配置文件.config中定义的连接字符串名称</param>
		public Gsp_config_lineMO(string connectionStringName = null) : base(connectionStringName) { }
	    /// <summary>
	    /// 构造函数
	    /// </summary>
	    /// <param name="connectionString">数据库连接字符串，如server=192.168.1.1;database=testdb;uid=root;pwd=root</param>
	    /// <param name="commandTimeout">CommandTimeout时间</param>
	    public Gsp_config_lineMO(string connectionString, int commandTimeout) : base(connectionString, commandTimeout) { }
		...
		public override int Add(Gsp_config_lineEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_); 
		}
		public override async Task<int> AddAsync(Gsp_config_lineEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_); 
		}
	    private void RepairAddData(Gsp_config_lineEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		public int AddByBatch(IEnumerable<Gsp_config_lineEO> items, int batchCount, TransactionManager tm_ = null)
		{
			var ret = 0;
	    ...
	    public async Task<int> AddByBatchAsync(IEnumerable<Gsp_config_lineEO> items, int batchCount, TransactionManager tm_ = null)
	    {
	        var ret = 0;
	        foreach (var sql in BuildAddBatchSql(items, batchCount))
	        {
	    ...
	    private IEnumerable<string> BuildAddBatchSql(IEnumerable<Gsp_config_lineEO> items, int batchCount)
		{
			var count = 0;
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Remove(Gsp_config_lineEO item, TransactionManager tm_ = null)
		{
			return RemoveByPK(item.LineNo, tm_);
		}
		public async Task<int> RemoveAsync(Gsp_config_lineEO item, TransactionManager tm_ = null)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(Gsp_config_lineEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutAsync(Gsp_config_lineEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutData(Gsp_config_lineEO item, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(IEnumerable<Gsp_config_lineEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public async Task<int> PutAsync(IEnumerable<Gsp_config_lineEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public bool Set(Gsp_config_lineEO item, TransactionManager tm = null)
		{
			bool ret = true;
		...
		public async Task<bool> SetAsync(Gsp_config_lineEO item, TransactionManager tm = null)
		{
			bool ret = true;
			if(GetByPK(item.LineNo) == null)
			{
		...
		/// <return></return>
		public Gsp_config_lineEO GetByPK(int lineNo, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(lineNo, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return Database.ExecSqlSingle(sql_, paras_, tm_, Gsp_config_lineEO.MapDataReader);
		}
		public async Task<Gsp_config_lineEO> GetByPKAsync(int lineNo, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(lineNo, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Gsp_config_lineEO.MapDataReader);
		}
		...
		public List<Gsp_config_lineEO> GetByLine(string line)
		{
			return GetByLine(line, 0, string.Empty, null);
		}
		public async Task<List<Gsp_config_lineEO>> GetByLineAsync(string line)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_config_lineEO> GetByLine(string line, TransactionManager tm_)
		{
			return GetByLine(line, 0, string.Empty, tm_);
		}
		public async Task<List<Gsp_config_lineEO>> GetByLineAsync(string line, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Gsp_config_lineEO> GetByLine(string line, int top_)
		{
			return GetByLine(line, top_, string.Empty, null);
		}
		public async Task<List<Gsp_config_lineEO>> GetByLineAsync(string line, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_config_lineEO> GetByLine(string line, int top_, TransactionManager tm_)
		{
			return GetByLine(line, top_, string.Empty, tm_);
		}
		public async Task<List<Gsp_config_lineEO>> GetByLineAsync(string line, int top_, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Gsp_config_lineEO> GetByLine(string line, string sort_)
		{
			return GetByLine(line, 0, sort_, null);
		}
		public async Task<List<Gsp_config_lineEO>> GetByLineAsync(string line, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_config_lineEO> GetByLine(string line, string sort_, TransactionManager tm_)
		{
			return GetByLine(line, 0, sort_, tm_);
		}
		public async Task<List<Gsp_config_lineEO>> GetByLineAsync(string line, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_config_lineEO> GetByLine(string line, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`Line` = @Line", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@Line", line, MySqlDbType.VarChar));
			return Database.ExecSqlList(sql_, paras_, tm_, Gsp_config_lineEO.MapDataReader);
		}
		public async Task<List<Gsp_config_lineEO>> GetByLineAsync(string line, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`Line` = @Line", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@Line", line, MySqlDbType.VarChar));
			return await Database.ExecSqlListAsync(sql_, paras_, tm_, Gsp_config_lineEO.MapDataReader);
		}
		#endregion // GetByLine
		#endregion // GetByXXX
		#endregion // Get
