...
namespace Super_phoenix.DAL
{
	...
	/// <summary>
	/// 用户扩展数据
	/// 【表 gsp_user_data 的实体类】
	/// </summary>
	[DataContract]
	[Obsolete]
	public class Gsp_user_dataEO : IRowMapper<Gsp_user_dataEO>
	{
		/// <summary>
		/// 构造函数 
		/// </summary>
		public Gsp_user_dataEO()
		{
			this.ChipsID = 0;
		...
		/// <return>实体对象</return>
		public Gsp_user_dataEO MapRow(IDataReader reader)
		{
		...
		/// <param name = "reader">只进结果集流</param>
		/// <return>实体对象</return>
		public static Gsp_user_dataEO MapDataReader(IDataReader reader)
		{
		    Gsp_user_dataEO ret = new Gsp_user_dataEO();
	...
	/// <summary>
	/// 用户扩展数据
	/// 【表 gsp_user_data 的操作类】
	/// </summary>
	[Obsolete]
	public class Gsp_user_dataMO : MySqlTableMO<Gsp_user_dataEO>
	{
		/// <summary>
		/// 表名
		/// </summary>
	    public override string TableName { get; set; } = "`gsp_user_data`";
		...
		public Gsp_user_dataMO(MySqlDatabase database) : base(database) { }
		/// <summary>
		/// 构造函数
		/// </summary>
		/// <param name = "connectionStringName">配置文件.config中定义的连接字符串名称</param>
		public Gsp_user_dataMO(string connectionStringName = null) : base(connectionStringName) { }
	    /// <summary>
	    /// 构造函数
	    /// </summary>
	    /// <param name="connectionString">数据库连接字符串，如server=192.168.1.1;database=testdb;uid=root;pwd=root</param>
	    /// <param name="commandTimeout">CommandTimeout时间</param>
	    public Gsp_user_dataMO(string connectionString, int commandTimeout) : base(connectionString, commandTimeout) { }
		...
		public override int Add(Gsp_user_dataEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_); 
		}
		public override async Task<int> AddAsync(Gsp_user_dataEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_); 
		}
	    private void RepairAddData(Gsp_user_dataEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		public int AddByBatch(IEnumerable<Gsp_user_dataEO> items, int batchCount, TransactionManager tm_ = null)
		{
			var ret = 0;
	    ...
	    public async Task<int> AddByBatchAsync(IEnumerable<Gsp_user_dataEO> items, int batchCount, TransactionManager tm_ = null)
	    {
	        var ret = 0;
	        foreach (var sql in BuildAddBatchSql(items, batchCount))
	        {
	    ...
	    private IEnumerable<string> BuildAddBatchSql(IEnumerable<Gsp_user_dataEO> items, int batchCount)
		{
			var count = 0;
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Remove(Gsp_user_dataEO item, TransactionManager tm_ = null)
		{
			return RemoveByPK(item.UserID, item.ChipsID, tm_);
		}
		public async Task<int> RemoveAsync(Gsp_user_dataEO item, TransactionManager tm_ = null)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(Gsp_user_dataEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutAsync(Gsp_user_dataEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutData(Gsp_user_dataEO item, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(IEnumerable<Gsp_user_dataEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public async Task<int> PutAsync(IEnumerable<Gsp_user_dataEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public bool Set(Gsp_user_dataEO item, TransactionManager tm = null)
		{
			bool ret = true;
		...
		public async Task<bool> SetAsync(Gsp_user_dataEO item, TransactionManager tm = null)
		{
			bool ret = true;
			if(GetByPK(item.UserID, item.ChipsID) == null)
			{
		...
		/// <return></return>
		public Gsp_user_dataEO GetByPK(string userID, int chipsID, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(userID, chipsID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return Database.ExecSqlSingle(sql_, paras_, tm_, Gsp_user_dataEO.MapDataReader);
		}
		public async Task<Gsp_user_dataEO> GetByPKAsync(string userID, int chipsID, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(userID, chipsID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Gsp_user_dataEO.MapDataReader);
		}
		private void RepairGetByPKData(string userID, int chipsID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false, TransactionManager tm_ = null)
		{
		...
		public List<Gsp_user_dataEO> GetByUserID(string userID)
		{
			return GetByUserID(userID, 0, string.Empty, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByUserIDAsync(string userID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByUserID(string userID, TransactionManager tm_)
		{
			return GetByUserID(userID, 0, string.Empty, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByUserIDAsync(string userID, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByUserID(string userID, int top_)
		{
			return GetByUserID(userID, top_, string.Empty, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByUserIDAsync(string userID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByUserID(string userID, int top_, TransactionManager tm_)
		{
			return GetByUserID(userID, top_, string.Empty, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByUserIDAsync(string userID, int top_, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByUserID(string userID, string sort_)
		{
			return GetByUserID(userID, 0, sort_, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByUserIDAsync(string userID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByUserID(string userID, string sort_, TransactionManager tm_)
		{
			return GetByUserID(userID, 0, sort_, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByUserIDAsync(string userID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByUserID(string userID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`UserID` = @UserID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@UserID", userID, MySqlDbType.VarChar));
			return Database.ExecSqlList(sql_, paras_, tm_, Gsp_user_dataEO.MapDataReader);
		}
		public async Task<List<Gsp_user_dataEO>> GetByUserIDAsync(string userID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`UserID` = @UserID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@UserID", userID, MySqlDbType.VarChar));
			return await Database.ExecSqlListAsync(sql_, paras_, tm_, Gsp_user_dataEO.MapDataReader);
		}
		...
		/// /// <param name = "chipsID">下注id</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByChipsID(int chipsID)
		{
			return GetByChipsID(chipsID, 0, string.Empty, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByChipsIDAsync(int chipsID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByChipsID(int chipsID, TransactionManager tm_)
		{
			return GetByChipsID(chipsID, 0, string.Empty, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByChipsIDAsync(int chipsID, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByChipsID(int chipsID, int top_)
		{
			return GetByChipsID(chipsID, top_, string.Empty, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByChipsIDAsync(int chipsID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByChipsID(int chipsID, int top_, TransactionManager tm_)
		{
			return GetByChipsID(chipsID, top_, string.Empty, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByChipsIDAsync(int chipsID, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByChipsID(int chipsID, string sort_)
		{
			return GetByChipsID(chipsID, 0, sort_, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByChipsIDAsync(int chipsID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByChipsID(int chipsID, string sort_, TransactionManager tm_)
		{
			return GetByChipsID(chipsID, 0, sort_, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByChipsIDAsync(int chipsID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByChipsID(int chipsID, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Gsp_user_dataEO>> GetByChipsIDAsync(int chipsID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`ChipsID` = @ChipsID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@ChipsID", chipsID, MySqlDbType.Int32));
		...
		/// /// <param name = "freeSpinCount">FreeSpin次数</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinCount(int freeSpinCount)
		{
			return GetByFreeSpinCount(freeSpinCount, 0, string.Empty, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinCountAsync(int freeSpinCount)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinCount(int freeSpinCount, TransactionManager tm_)
		{
			return GetByFreeSpinCount(freeSpinCount, 0, string.Empty, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinCountAsync(int freeSpinCount, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinCount(int freeSpinCount, int top_)
		{
			return GetByFreeSpinCount(freeSpinCount, top_, string.Empty, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinCountAsync(int freeSpinCount, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinCount(int freeSpinCount, int top_, TransactionManager tm_)
		{
			return GetByFreeSpinCount(freeSpinCount, top_, string.Empty, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinCountAsync(int freeSpinCount, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinCount(int freeSpinCount, string sort_)
		{
			return GetByFreeSpinCount(freeSpinCount, 0, sort_, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinCountAsync(int freeSpinCount, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinCount(int freeSpinCount, string sort_, TransactionManager tm_)
		{
			return GetByFreeSpinCount(freeSpinCount, 0, sort_, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinCountAsync(int freeSpinCount, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinCount(int freeSpinCount, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinCountAsync(int freeSpinCount, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`FreeSpinCount` = @FreeSpinCount", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@FreeSpinCount", freeSpinCount, MySqlDbType.Int32));
		...
		/// /// <param name = "freeSpinTotalReward">FreeSpin次数的总奖励</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinTotalReward(long freeSpinTotalReward)
		{
			return GetByFreeSpinTotalReward(freeSpinTotalReward, 0, string.Empty, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinTotalRewardAsync(long freeSpinTotalReward)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinTotalReward(long freeSpinTotalReward, TransactionManager tm_)
		{
			return GetByFreeSpinTotalReward(freeSpinTotalReward, 0, string.Empty, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinTotalRewardAsync(long freeSpinTotalReward, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinTotalReward(long freeSpinTotalReward, int top_)
		{
			return GetByFreeSpinTotalReward(freeSpinTotalReward, top_, string.Empty, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinTotalRewardAsync(long freeSpinTotalReward, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinTotalReward(long freeSpinTotalReward, int top_, TransactionManager tm_)
		{
			return GetByFreeSpinTotalReward(freeSpinTotalReward, top_, string.Empty, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinTotalRewardAsync(long freeSpinTotalReward, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinTotalReward(long freeSpinTotalReward, string sort_)
		{
			return GetByFreeSpinTotalReward(freeSpinTotalReward, 0, sort_, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinTotalRewardAsync(long freeSpinTotalReward, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinTotalReward(long freeSpinTotalReward, string sort_, TransactionManager tm_)
		{
			return GetByFreeSpinTotalReward(freeSpinTotalReward, 0, sort_, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinTotalRewardAsync(long freeSpinTotalReward, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByFreeSpinTotalReward(long freeSpinTotalReward, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Gsp_user_dataEO>> GetByFreeSpinTotalRewardAsync(long freeSpinTotalReward, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`FreeSpinTotalReward` = @FreeSpinTotalReward", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@FreeSpinTotalReward", freeSpinTotalReward, MySqlDbType.Int64));
		...
		/// /// <param name = "lastRecDate">记录最后记录时间</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByLastRecDate(DateTime? lastRecDate)
		{
			return GetByLastRecDate(lastRecDate, 0, string.Empty, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByLastRecDateAsync(DateTime? lastRecDate)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByLastRecDate(DateTime? lastRecDate, TransactionManager tm_)
		{
			return GetByLastRecDate(lastRecDate, 0, string.Empty, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByLastRecDateAsync(DateTime? lastRecDate, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByLastRecDate(DateTime? lastRecDate, int top_)
		{
			return GetByLastRecDate(lastRecDate, top_, string.Empty, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByLastRecDateAsync(DateTime? lastRecDate, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByLastRecDate(DateTime? lastRecDate, int top_, TransactionManager tm_)
		{
			return GetByLastRecDate(lastRecDate, top_, string.Empty, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByLastRecDateAsync(DateTime? lastRecDate, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByLastRecDate(DateTime? lastRecDate, string sort_)
		{
			return GetByLastRecDate(lastRecDate, 0, sort_, null);
		}
		public async Task<List<Gsp_user_dataEO>> GetByLastRecDateAsync(DateTime? lastRecDate, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByLastRecDate(DateTime? lastRecDate, string sort_, TransactionManager tm_)
		{
			return GetByLastRecDate(lastRecDate, 0, sort_, tm_);
		}
		public async Task<List<Gsp_user_dataEO>> GetByLastRecDateAsync(DateTime? lastRecDate, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Gsp_user_dataEO> GetByLastRecDate(DateTime? lastRecDate, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Gsp_user_dataEO>> GetByLastRecDateAsync(DateTime? lastRecDate, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL(lastRecDate.HasValue ? "`LastRecDate` = @LastRecDate" : "`LastRecDate` IS NULL", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			if (lastRecDate.HasValue)
