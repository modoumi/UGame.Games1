...
namespace Fortune_rabbit.DAL
{
	...
	/// <summary>
	/// 所有奖池权重
	/// 【表 fra_config_weight 的实体类】
	/// </summary>
	[DataContract]
	[Obsolete]
	public class Fra_config_weightEO : IRowMapper<Fra_config_weightEO>
	{
		/// <summary>
		/// 构造函数 
		/// </summary>
		public Fra_config_weightEO()
		{
			this.Weight1 = 0;
			this.Weight2 = 0;
			this.Weight3 = 0;
		...
		/// <return>实体对象</return>
		public Fra_config_weightEO MapRow(IDataReader reader)
		{
		...
		/// <param name = "reader">只进结果集流</param>
		/// <return>实体对象</return>
		public static Fra_config_weightEO MapDataReader(IDataReader reader)
		{
		    Fra_config_weightEO ret = new Fra_config_weightEO();
	...
	/// <summary>
	/// 所有奖池权重
	/// 【表 fra_config_weight 的操作类】
	/// </summary>
	[Obsolete]
	public class Fra_config_weightMO : MySqlTableMO<Fra_config_weightEO>
	{
		/// <summary>
		/// 表名
		/// </summary>
	    public override string TableName { get; set; } = "`fra_config_weight`";
		...
		public Fra_config_weightMO(MySqlDatabase database) : base(database) { }
		/// <summary>
		/// 构造函数
		/// </summary>
		/// <param name = "connectionStringName">配置文件.config中定义的连接字符串名称</param>
		public Fra_config_weightMO(string connectionStringName = null) : base(connectionStringName) { }
	    /// <summary>
	    /// 构造函数
	    /// </summary>
	    /// <param name="connectionString">数据库连接字符串，如server=192.168.1.1;database=testdb;uid=root;pwd=root</param>
	    /// <param name="commandTimeout">CommandTimeout时间</param>
	    public Fra_config_weightMO(string connectionString, int commandTimeout) : base(connectionString, commandTimeout) { }
		...
		public override int Add(Fra_config_weightEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_); 
		}
		public override async Task<int> AddAsync(Fra_config_weightEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_); 
		}
	    private void RepairAddData(Fra_config_weightEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = useIgnore_ ? "INSERT IGNORE" : "INSERT";
			sql_ += $" INTO {TableName} (`ItemID`, `IconType`, `Weight1`, `Weight2`, `Weight3`) VALUE (@ItemID, @IconType, @Weight1, @Weight2, @Weight3);";
		...
		public int AddByBatch(IEnumerable<Fra_config_weightEO> items, int batchCount, TransactionManager tm_ = null)
		{
			var ret = 0;
	    ...
	    public async Task<int> AddByBatchAsync(IEnumerable<Fra_config_weightEO> items, int batchCount, TransactionManager tm_ = null)
	    {
	        var ret = 0;
	        foreach (var sql in BuildAddBatchSql(items, batchCount))
	        {
	    ...
	    private IEnumerable<string> BuildAddBatchSql(IEnumerable<Fra_config_weightEO> items, int batchCount)
		{
			var count = 0;
	        var insertSql = $"INSERT INTO {TableName} (`ItemID`, `IconType`, `Weight1`, `Weight2`, `Weight3`) VALUES ";
			var sql = new StringBuilder();
	        foreach (var item in items)
			{
				count++;
				sql.Append($"({item.ItemID},{item.IconType},{item.Weight1},{item.Weight2},{item.Weight3}),");
				if (count == batchCount)
				{
					count = 0;
		...
		/// /// <param name = "iconType">icon类型1-普通,2-万能</param>
		/// <param name="tm_">事务管理对象</param>
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Remove(Fra_config_weightEO item, TransactionManager tm_ = null)
		{
			return RemoveByPK(item.ItemID, item.IconType, tm_);
		}
		public async Task<int> RemoveAsync(Fra_config_weightEO item, TransactionManager tm_ = null)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(Fra_config_weightEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutAsync(Fra_config_weightEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutData(Fra_config_weightEO item, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = $"UPDATE {TableName} SET `ItemID` = @ItemID, `IconType` = @IconType, `Weight1` = @Weight1, `Weight2` = @Weight2, `Weight3` = @Weight3 WHERE `ItemID` = @ItemID_Original AND `IconType` = @IconType_Original";
			paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ItemID", item.ItemID, MySqlDbType.Int32),
				Database.CreateInParameter("@IconType", item.IconType, MySqlDbType.Int32),
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(IEnumerable<Fra_config_weightEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public async Task<int> PutAsync(IEnumerable<Fra_config_weightEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int PutWeight1ByPK(int itemID, int iconType, int weight1, TransactionManager tm_ = null)
		{
			RepairPutWeight1ByPKData(itemID, iconType, weight1, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutWeight1ByPKAsync(int itemID, int iconType, int weight1, TransactionManager tm_ = null)
		{
			RepairPutWeight1ByPKData(itemID, iconType, weight1, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutWeight1ByPKData(int itemID, int iconType, int weight1, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = $"UPDATE {TableName} SET `Weight1` = @Weight1  WHERE `ItemID` = @ItemID AND `IconType` = @IconType";
			paras_ = new List<MySqlParameter>() 
			{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int PutWeight2ByPK(int itemID, int iconType, int weight2, TransactionManager tm_ = null)
		{
			RepairPutWeight2ByPKData(itemID, iconType, weight2, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutWeight2ByPKAsync(int itemID, int iconType, int weight2, TransactionManager tm_ = null)
		{
			RepairPutWeight2ByPKData(itemID, iconType, weight2, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutWeight2ByPKData(int itemID, int iconType, int weight2, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = $"UPDATE {TableName} SET `Weight2` = @Weight2  WHERE `ItemID` = @ItemID AND `IconType` = @IconType";
			paras_ = new List<MySqlParameter>() 
			{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int PutWeight3ByPK(int itemID, int iconType, int weight3, TransactionManager tm_ = null)
		{
			RepairPutWeight3ByPKData(itemID, iconType, weight3, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutWeight3ByPKAsync(int itemID, int iconType, int weight3, TransactionManager tm_ = null)
		{
			RepairPutWeight3ByPKData(itemID, iconType, weight3, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutWeight3ByPKData(int itemID, int iconType, int weight3, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = $"UPDATE {TableName} SET `Weight3` = @Weight3  WHERE `ItemID` = @ItemID AND `IconType` = @IconType";
			paras_ = new List<MySqlParameter>() 
			{
		...
		public bool Set(Fra_config_weightEO item, TransactionManager tm = null)
		{
			bool ret = true;
		...
		public async Task<bool> SetAsync(Fra_config_weightEO item, TransactionManager tm = null)
		{
			bool ret = true;
			if(GetByPK(item.ItemID, item.IconType) == null)
			{
		...
		/// <return></return>
		public Fra_config_weightEO GetByPK(int itemID, int iconType, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(itemID, iconType, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return Database.ExecSqlSingle(sql_, paras_, tm_, Fra_config_weightEO.MapDataReader);
		}
		public async Task<Fra_config_weightEO> GetByPKAsync(int itemID, int iconType, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(itemID, iconType, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Fra_config_weightEO.MapDataReader);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public int GetWeight1ByPK(int itemID, int iconType, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ItemID", itemID, MySqlDbType.Int32),
			...
			return (int)GetScalar("`Weight1`", "`ItemID` = @ItemID AND `IconType` = @IconType", paras_, tm_);
		}
		public async Task<int> GetWeight1ByPKAsync(int itemID, int iconType, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ItemID", itemID, MySqlDbType.Int32),
			...
			return (int)await GetScalarAsync("`Weight1`", "`ItemID` = @ItemID AND `IconType` = @IconType", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public int GetWeight2ByPK(int itemID, int iconType, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ItemID", itemID, MySqlDbType.Int32),
			...
			return (int)GetScalar("`Weight2`", "`ItemID` = @ItemID AND `IconType` = @IconType", paras_, tm_);
		}
		public async Task<int> GetWeight2ByPKAsync(int itemID, int iconType, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ItemID", itemID, MySqlDbType.Int32),
			...
			return (int)await GetScalarAsync("`Weight2`", "`ItemID` = @ItemID AND `IconType` = @IconType", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public int GetWeight3ByPK(int itemID, int iconType, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ItemID", itemID, MySqlDbType.Int32),
			...
			return (int)GetScalar("`Weight3`", "`ItemID` = @ItemID AND `IconType` = @IconType", paras_, tm_);
		}
		public async Task<int> GetWeight3ByPKAsync(int itemID, int iconType, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ItemID", itemID, MySqlDbType.Int32),
			...
			return (int)await GetScalarAsync("`Weight3`", "`ItemID` = @ItemID AND `IconType` = @IconType", paras_, tm_);
		}
		...
		public List<Fra_config_weightEO> GetByItemID(int itemID)
		{
			return GetByItemID(itemID, 0, string.Empty, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByItemIDAsync(int itemID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByItemID(int itemID, TransactionManager tm_)
		{
			return GetByItemID(itemID, 0, string.Empty, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByItemIDAsync(int itemID, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByItemID(int itemID, int top_)
		{
			return GetByItemID(itemID, top_, string.Empty, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByItemIDAsync(int itemID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByItemID(int itemID, int top_, TransactionManager tm_)
		{
			return GetByItemID(itemID, top_, string.Empty, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByItemIDAsync(int itemID, int top_, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByItemID(int itemID, string sort_)
		{
			return GetByItemID(itemID, 0, sort_, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByItemIDAsync(int itemID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByItemID(int itemID, string sort_, TransactionManager tm_)
		{
			return GetByItemID(itemID, 0, sort_, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByItemIDAsync(int itemID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByItemID(int itemID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`ItemID` = @ItemID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@ItemID", itemID, MySqlDbType.Int32));
			return Database.ExecSqlList(sql_, paras_, tm_, Fra_config_weightEO.MapDataReader);
		}
		public async Task<List<Fra_config_weightEO>> GetByItemIDAsync(int itemID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`ItemID` = @ItemID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@ItemID", itemID, MySqlDbType.Int32));
			return await Database.ExecSqlListAsync(sql_, paras_, tm_, Fra_config_weightEO.MapDataReader);
		}
		...
		/// /// <param name = "iconType">icon类型1-普通,2-万能</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByIconType(int iconType)
		{
			return GetByIconType(iconType, 0, string.Empty, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByIconTypeAsync(int iconType)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByIconType(int iconType, TransactionManager tm_)
		{
			return GetByIconType(iconType, 0, string.Empty, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByIconTypeAsync(int iconType, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByIconType(int iconType, int top_)
		{
			return GetByIconType(iconType, top_, string.Empty, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByIconTypeAsync(int iconType, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByIconType(int iconType, int top_, TransactionManager tm_)
		{
			return GetByIconType(iconType, top_, string.Empty, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByIconTypeAsync(int iconType, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByIconType(int iconType, string sort_)
		{
			return GetByIconType(iconType, 0, sort_, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByIconTypeAsync(int iconType, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByIconType(int iconType, string sort_, TransactionManager tm_)
		{
			return GetByIconType(iconType, 0, sort_, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByIconTypeAsync(int iconType, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByIconType(int iconType, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fra_config_weightEO>> GetByIconTypeAsync(int iconType, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`IconType` = @IconType", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@IconType", iconType, MySqlDbType.Int32));
		...
		/// /// <param name = "weight1">轴1权重</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight1(int weight1)
		{
			return GetByWeight1(weight1, 0, string.Empty, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight1Async(int weight1)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight1(int weight1, TransactionManager tm_)
		{
			return GetByWeight1(weight1, 0, string.Empty, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight1Async(int weight1, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight1(int weight1, int top_)
		{
			return GetByWeight1(weight1, top_, string.Empty, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight1Async(int weight1, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight1(int weight1, int top_, TransactionManager tm_)
		{
			return GetByWeight1(weight1, top_, string.Empty, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight1Async(int weight1, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight1(int weight1, string sort_)
		{
			return GetByWeight1(weight1, 0, sort_, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight1Async(int weight1, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight1(int weight1, string sort_, TransactionManager tm_)
		{
			return GetByWeight1(weight1, 0, sort_, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight1Async(int weight1, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight1(int weight1, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fra_config_weightEO>> GetByWeight1Async(int weight1, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`Weight1` = @Weight1", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@Weight1", weight1, MySqlDbType.Int32));
		...
		/// /// <param name = "weight2">轴2权重</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight2(int weight2)
		{
			return GetByWeight2(weight2, 0, string.Empty, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight2Async(int weight2)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight2(int weight2, TransactionManager tm_)
		{
			return GetByWeight2(weight2, 0, string.Empty, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight2Async(int weight2, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight2(int weight2, int top_)
		{
			return GetByWeight2(weight2, top_, string.Empty, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight2Async(int weight2, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight2(int weight2, int top_, TransactionManager tm_)
		{
			return GetByWeight2(weight2, top_, string.Empty, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight2Async(int weight2, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight2(int weight2, string sort_)
		{
			return GetByWeight2(weight2, 0, sort_, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight2Async(int weight2, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight2(int weight2, string sort_, TransactionManager tm_)
		{
			return GetByWeight2(weight2, 0, sort_, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight2Async(int weight2, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight2(int weight2, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fra_config_weightEO>> GetByWeight2Async(int weight2, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`Weight2` = @Weight2", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@Weight2", weight2, MySqlDbType.Int32));
		...
		/// /// <param name = "weight3">轴3权重</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight3(int weight3)
		{
			return GetByWeight3(weight3, 0, string.Empty, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight3Async(int weight3)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight3(int weight3, TransactionManager tm_)
		{
			return GetByWeight3(weight3, 0, string.Empty, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight3Async(int weight3, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight3(int weight3, int top_)
		{
			return GetByWeight3(weight3, top_, string.Empty, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight3Async(int weight3, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight3(int weight3, int top_, TransactionManager tm_)
		{
			return GetByWeight3(weight3, top_, string.Empty, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight3Async(int weight3, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight3(int weight3, string sort_)
		{
			return GetByWeight3(weight3, 0, sort_, null);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight3Async(int weight3, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight3(int weight3, string sort_, TransactionManager tm_)
		{
			return GetByWeight3(weight3, 0, sort_, tm_);
		}
		public async Task<List<Fra_config_weightEO>> GetByWeight3Async(int weight3, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_weightEO> GetByWeight3(int weight3, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fra_config_weightEO>> GetByWeight3Async(int weight3, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`Weight3` = @Weight3", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@Weight3", weight3, MySqlDbType.Int32));
