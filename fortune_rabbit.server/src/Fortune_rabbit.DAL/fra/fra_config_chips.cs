...
namespace Fortune_rabbit.DAL
{
	...
	/// <summary>
	/// 下注筹码表
	/// 【表 fra_config_chips 的实体类】
	/// </summary>
	[DataContract]
	[Obsolete]
	public class Fra_config_chipsEO : IRowMapper<Fra_config_chipsEO>
	{
		/// <summary>
		/// 构造函数 
		/// </summary>
		public Fra_config_chipsEO()
		{
			this.BetAmount = 0;
			this.SingleAmount = 0;
			this.LineNum = 0;
		...
		/// <return>实体对象</return>
		public Fra_config_chipsEO MapRow(IDataReader reader)
		{
		...
		/// <param name = "reader">只进结果集流</param>
		/// <return>实体对象</return>
		public static Fra_config_chipsEO MapDataReader(IDataReader reader)
		{
		    Fra_config_chipsEO ret = new Fra_config_chipsEO();
	...
	/// <summary>
	/// 下注筹码表
	/// 【表 fra_config_chips 的操作类】
	/// </summary>
	[Obsolete]
	public class Fra_config_chipsMO : MySqlTableMO<Fra_config_chipsEO>
	{
		/// <summary>
		/// 表名
		/// </summary>
	    public override string TableName { get; set; } = "`fra_config_chips`";
		...
		public Fra_config_chipsMO(MySqlDatabase database) : base(database) { }
		/// <summary>
		/// 构造函数
		/// </summary>
		/// <param name = "connectionStringName">配置文件.config中定义的连接字符串名称</param>
		public Fra_config_chipsMO(string connectionStringName = null) : base(connectionStringName) { }
	    /// <summary>
	    /// 构造函数
	    /// </summary>
	    /// <param name="connectionString">数据库连接字符串，如server=192.168.1.1;database=testdb;uid=root;pwd=root</param>
	    /// <param name="commandTimeout">CommandTimeout时间</param>
	    public Fra_config_chipsMO(string connectionString, int commandTimeout) : base(connectionString, commandTimeout) { }
		...
		public override int Add(Fra_config_chipsEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			item.ChipsID = Database.ExecSqlScalar<int>(sql_, paras_, tm_); 
			return 1;
		}
		public override async Task<int> AddAsync(Fra_config_chipsEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			item.ChipsID = await Database.ExecSqlScalarAsync<int>(sql_, paras_, tm_); 
	        return 1;
		}
	    private void RepairAddData(Fra_config_chipsEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		public int AddByBatch(IEnumerable<Fra_config_chipsEO> items, int batchCount, TransactionManager tm_ = null)
		{
			var ret = 0;
	    ...
	    public async Task<int> AddByBatchAsync(IEnumerable<Fra_config_chipsEO> items, int batchCount, TransactionManager tm_ = null)
	    {
	        var ret = 0;
	        foreach (var sql in BuildAddBatchSql(items, batchCount))
	        {
	    ...
	    private IEnumerable<string> BuildAddBatchSql(IEnumerable<Fra_config_chipsEO> items, int batchCount)
		{
			var count = 0;
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Remove(Fra_config_chipsEO item, TransactionManager tm_ = null)
		{
			return RemoveByPK(item.ChipsID, tm_);
		}
		public async Task<int> RemoveAsync(Fra_config_chipsEO item, TransactionManager tm_ = null)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(Fra_config_chipsEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutAsync(Fra_config_chipsEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutData(Fra_config_chipsEO item, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(IEnumerable<Fra_config_chipsEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public async Task<int> PutAsync(IEnumerable<Fra_config_chipsEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public bool Set(Fra_config_chipsEO item, TransactionManager tm = null)
		{
			bool ret = true;
		...
		public async Task<bool> SetAsync(Fra_config_chipsEO item, TransactionManager tm = null)
		{
			bool ret = true;
			if(GetByPK(item.ChipsID) == null)
			{
		...
		/// <return></return>
		public Fra_config_chipsEO GetByPK(int chipsID, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(chipsID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return Database.ExecSqlSingle(sql_, paras_, tm_, Fra_config_chipsEO.MapDataReader);
		}
		public async Task<Fra_config_chipsEO> GetByPKAsync(int chipsID, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(chipsID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Fra_config_chipsEO.MapDataReader);
		}
		...
		public List<Fra_config_chipsEO> GetByBetAmount(long betAmount)
		{
			return GetByBetAmount(betAmount, 0, string.Empty, null);
		}
		public async Task<List<Fra_config_chipsEO>> GetByBetAmountAsync(long betAmount)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByBetAmount(long betAmount, TransactionManager tm_)
		{
			return GetByBetAmount(betAmount, 0, string.Empty, tm_);
		}
		public async Task<List<Fra_config_chipsEO>> GetByBetAmountAsync(long betAmount, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByBetAmount(long betAmount, int top_)
		{
			return GetByBetAmount(betAmount, top_, string.Empty, null);
		}
		public async Task<List<Fra_config_chipsEO>> GetByBetAmountAsync(long betAmount, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByBetAmount(long betAmount, int top_, TransactionManager tm_)
		{
			return GetByBetAmount(betAmount, top_, string.Empty, tm_);
		}
		public async Task<List<Fra_config_chipsEO>> GetByBetAmountAsync(long betAmount, int top_, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByBetAmount(long betAmount, string sort_)
		{
			return GetByBetAmount(betAmount, 0, sort_, null);
		}
		public async Task<List<Fra_config_chipsEO>> GetByBetAmountAsync(long betAmount, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByBetAmount(long betAmount, string sort_, TransactionManager tm_)
		{
			return GetByBetAmount(betAmount, 0, sort_, tm_);
		}
		public async Task<List<Fra_config_chipsEO>> GetByBetAmountAsync(long betAmount, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByBetAmount(long betAmount, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`BetAmount` = @BetAmount", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@BetAmount", betAmount, MySqlDbType.Int64));
			return Database.ExecSqlList(sql_, paras_, tm_, Fra_config_chipsEO.MapDataReader);
		}
		public async Task<List<Fra_config_chipsEO>> GetByBetAmountAsync(long betAmount, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`BetAmount` = @BetAmount", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@BetAmount", betAmount, MySqlDbType.Int64));
			return await Database.ExecSqlListAsync(sql_, paras_, tm_, Fra_config_chipsEO.MapDataReader);
		}
		...
		/// /// <param name = "singleAmount">单线下注金额</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetBySingleAmount(long singleAmount)
		{
			return GetBySingleAmount(singleAmount, 0, string.Empty, null);
		}
		public async Task<List<Fra_config_chipsEO>> GetBySingleAmountAsync(long singleAmount)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetBySingleAmount(long singleAmount, TransactionManager tm_)
		{
			return GetBySingleAmount(singleAmount, 0, string.Empty, tm_);
		}
		public async Task<List<Fra_config_chipsEO>> GetBySingleAmountAsync(long singleAmount, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetBySingleAmount(long singleAmount, int top_)
		{
			return GetBySingleAmount(singleAmount, top_, string.Empty, null);
		}
		public async Task<List<Fra_config_chipsEO>> GetBySingleAmountAsync(long singleAmount, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetBySingleAmount(long singleAmount, int top_, TransactionManager tm_)
		{
			return GetBySingleAmount(singleAmount, top_, string.Empty, tm_);
		}
		public async Task<List<Fra_config_chipsEO>> GetBySingleAmountAsync(long singleAmount, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetBySingleAmount(long singleAmount, string sort_)
		{
			return GetBySingleAmount(singleAmount, 0, sort_, null);
		}
		public async Task<List<Fra_config_chipsEO>> GetBySingleAmountAsync(long singleAmount, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetBySingleAmount(long singleAmount, string sort_, TransactionManager tm_)
		{
			return GetBySingleAmount(singleAmount, 0, sort_, tm_);
		}
		public async Task<List<Fra_config_chipsEO>> GetBySingleAmountAsync(long singleAmount, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetBySingleAmount(long singleAmount, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fra_config_chipsEO>> GetBySingleAmountAsync(long singleAmount, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`SingleAmount` = @SingleAmount", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@SingleAmount", singleAmount, MySqlDbType.Int64));
		...
		/// /// <param name = "lineNum">线数</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByLineNum(int lineNum)
		{
			return GetByLineNum(lineNum, 0, string.Empty, null);
		}
		public async Task<List<Fra_config_chipsEO>> GetByLineNumAsync(int lineNum)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByLineNum(int lineNum, TransactionManager tm_)
		{
			return GetByLineNum(lineNum, 0, string.Empty, tm_);
		}
		public async Task<List<Fra_config_chipsEO>> GetByLineNumAsync(int lineNum, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByLineNum(int lineNum, int top_)
		{
			return GetByLineNum(lineNum, top_, string.Empty, null);
		}
		public async Task<List<Fra_config_chipsEO>> GetByLineNumAsync(int lineNum, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByLineNum(int lineNum, int top_, TransactionManager tm_)
		{
			return GetByLineNum(lineNum, top_, string.Empty, tm_);
		}
		public async Task<List<Fra_config_chipsEO>> GetByLineNumAsync(int lineNum, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByLineNum(int lineNum, string sort_)
		{
			return GetByLineNum(lineNum, 0, sort_, null);
		}
		public async Task<List<Fra_config_chipsEO>> GetByLineNumAsync(int lineNum, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByLineNum(int lineNum, string sort_, TransactionManager tm_)
		{
			return GetByLineNum(lineNum, 0, sort_, tm_);
		}
		public async Task<List<Fra_config_chipsEO>> GetByLineNumAsync(int lineNum, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByLineNum(int lineNum, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fra_config_chipsEO>> GetByLineNumAsync(int lineNum, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`LineNum` = @LineNum", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@LineNum", lineNum, MySqlDbType.Int32));
		...
		/// /// <param name = "isShortcut">是否出现在+-</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByIsShortcut(int isShortcut)
		{
			return GetByIsShortcut(isShortcut, 0, string.Empty, null);
		}
		public async Task<List<Fra_config_chipsEO>> GetByIsShortcutAsync(int isShortcut)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByIsShortcut(int isShortcut, TransactionManager tm_)
		{
			return GetByIsShortcut(isShortcut, 0, string.Empty, tm_);
		}
		public async Task<List<Fra_config_chipsEO>> GetByIsShortcutAsync(int isShortcut, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByIsShortcut(int isShortcut, int top_)
		{
			return GetByIsShortcut(isShortcut, top_, string.Empty, null);
		}
		public async Task<List<Fra_config_chipsEO>> GetByIsShortcutAsync(int isShortcut, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByIsShortcut(int isShortcut, int top_, TransactionManager tm_)
		{
			return GetByIsShortcut(isShortcut, top_, string.Empty, tm_);
		}
		public async Task<List<Fra_config_chipsEO>> GetByIsShortcutAsync(int isShortcut, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByIsShortcut(int isShortcut, string sort_)
		{
			return GetByIsShortcut(isShortcut, 0, sort_, null);
		}
		public async Task<List<Fra_config_chipsEO>> GetByIsShortcutAsync(int isShortcut, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByIsShortcut(int isShortcut, string sort_, TransactionManager tm_)
		{
			return GetByIsShortcut(isShortcut, 0, sort_, tm_);
		}
		public async Task<List<Fra_config_chipsEO>> GetByIsShortcutAsync(int isShortcut, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fra_config_chipsEO> GetByIsShortcut(int isShortcut, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fra_config_chipsEO>> GetByIsShortcutAsync(int isShortcut, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`IsShortcut` = @IsShortcut", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@IsShortcut", isShortcut, MySqlDbType.Int32));
