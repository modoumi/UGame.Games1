...
namespace Fortune_mouse.DAL
{
	...
	[DataContract]
	[Obsolete]
	public class Fmo_configEO : IRowMapper<Fmo_configEO>
	{
		/// <summary>
		/// 构造函数 
		/// </summary>
		...
		/// <return>实体对象</return>
		public Fmo_configEO MapRow(IDataReader reader)
		{
		...
		/// <param name = "reader">只进结果集流</param>
		/// <return>实体对象</return>
		public static Fmo_configEO MapDataReader(IDataReader reader)
		{
		    Fmo_configEO ret = new Fmo_configEO();
	...
	/// </summary>
	[Obsolete]
	public class Fmo_configMO : MySqlTableMO<Fmo_configEO>
	{
		/// <summary>
		/// 表名
		/// </summary>
	    public override string TableName { get; set; } = "`fmo_config`";
		...
		public Fmo_configMO(MySqlDatabase database) : base(database) { }
		/// <summary>
		/// 构造函数
		/// </summary>
		/// <param name = "connectionStringName">配置文件.config中定义的连接字符串名称</param>
		public Fmo_configMO(string connectionStringName = null) : base(connectionStringName) { }
	    /// <summary>
	    /// 构造函数
	    /// </summary>
	    /// <param name="connectionString">数据库连接字符串，如server=192.168.1.1;database=testdb;uid=root;pwd=root</param>
	    /// <param name="commandTimeout">CommandTimeout时间</param>
	    public Fmo_configMO(string connectionString, int commandTimeout) : base(connectionString, commandTimeout) { }
		...
		public override int Add(Fmo_configEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_); 
		}
		public override async Task<int> AddAsync(Fmo_configEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_); 
		}
	    private void RepairAddData(Fmo_configEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = useIgnore_ ? "INSERT IGNORE" : "INSERT";
			sql_ += $" INTO {TableName} (`OperatorID`, `CurrencyID`, `IncomeRatio`, `MultipArray`, `DefaultSlotArray`) VALUE (@OperatorID, @CurrencyID, @IncomeRatio, @MultipArray, @DefaultSlotArray);";
		...
		public int AddByBatch(IEnumerable<Fmo_configEO> items, int batchCount, TransactionManager tm_ = null)
		{
			var ret = 0;
	    ...
	    public async Task<int> AddByBatchAsync(IEnumerable<Fmo_configEO> items, int batchCount, TransactionManager tm_ = null)
	    {
	        var ret = 0;
	        foreach (var sql in BuildAddBatchSql(items, batchCount))
	        {
	    ...
	    private IEnumerable<string> BuildAddBatchSql(IEnumerable<Fmo_configEO> items, int batchCount)
		{
			var count = 0;
	        var insertSql = $"INSERT INTO {TableName} (`OperatorID`, `CurrencyID`, `IncomeRatio`, `MultipArray`, `DefaultSlotArray`) VALUES ";
			var sql = new StringBuilder();
	        foreach (var item in items)
			{
				count++;
				sql.Append($"('{item.OperatorID}','{item.CurrencyID}',{item.IncomeRatio},'{item.MultipArray}','{item.DefaultSlotArray}'),");
				if (count == batchCount)
				{
					count = 0;
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Remove(Fmo_configEO item, TransactionManager tm_ = null)
		{
			return RemoveByPK(item.OperatorID, item.CurrencyID, tm_);
		}
		public async Task<int> RemoveAsync(Fmo_configEO item, TransactionManager tm_ = null)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(Fmo_configEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutAsync(Fmo_configEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutData(Fmo_configEO item, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = $"UPDATE {TableName} SET `OperatorID` = @OperatorID, `CurrencyID` = @CurrencyID, `IncomeRatio` = @IncomeRatio, `MultipArray` = @MultipArray, `DefaultSlotArray` = @DefaultSlotArray WHERE `OperatorID` = @OperatorID_Original AND `CurrencyID` = @CurrencyID_Original";
			paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@OperatorID", item.OperatorID, MySqlDbType.VarChar),
				Database.CreateInParameter("@CurrencyID", item.CurrencyID, MySqlDbType.VarChar),
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(IEnumerable<Fmo_configEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public async Task<int> PutAsync(IEnumerable<Fmo_configEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public bool Set(Fmo_configEO item, TransactionManager tm = null)
		{
			bool ret = true;
		...
		public async Task<bool> SetAsync(Fmo_configEO item, TransactionManager tm = null)
		{
			bool ret = true;
			if(GetByPK(item.OperatorID, item.CurrencyID) == null)
			{
		...
		/// <return></return>
		public Fmo_configEO GetByPK(string operatorID, string currencyID, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(operatorID, currencyID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return Database.ExecSqlSingle(sql_, paras_, tm_, Fmo_configEO.MapDataReader);
		}
		public async Task<Fmo_configEO> GetByPKAsync(string operatorID, string currencyID, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(operatorID, currencyID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Fmo_configEO.MapDataReader);
		}
		...
		public List<Fmo_configEO> GetByOperatorID(string operatorID)
		{
			return GetByOperatorID(operatorID, 0, string.Empty, null);
		}
		public async Task<List<Fmo_configEO>> GetByOperatorIDAsync(string operatorID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByOperatorID(string operatorID, TransactionManager tm_)
		{
			return GetByOperatorID(operatorID, 0, string.Empty, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByOperatorIDAsync(string operatorID, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByOperatorID(string operatorID, int top_)
		{
			return GetByOperatorID(operatorID, top_, string.Empty, null);
		}
		public async Task<List<Fmo_configEO>> GetByOperatorIDAsync(string operatorID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByOperatorID(string operatorID, int top_, TransactionManager tm_)
		{
			return GetByOperatorID(operatorID, top_, string.Empty, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByOperatorIDAsync(string operatorID, int top_, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByOperatorID(string operatorID, string sort_)
		{
			return GetByOperatorID(operatorID, 0, sort_, null);
		}
		public async Task<List<Fmo_configEO>> GetByOperatorIDAsync(string operatorID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByOperatorID(string operatorID, string sort_, TransactionManager tm_)
		{
			return GetByOperatorID(operatorID, 0, sort_, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByOperatorIDAsync(string operatorID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByOperatorID(string operatorID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`OperatorID` = @OperatorID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@OperatorID", operatorID, MySqlDbType.VarChar));
			return Database.ExecSqlList(sql_, paras_, tm_, Fmo_configEO.MapDataReader);
		}
		public async Task<List<Fmo_configEO>> GetByOperatorIDAsync(string operatorID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`OperatorID` = @OperatorID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@OperatorID", operatorID, MySqlDbType.VarChar));
			return await Database.ExecSqlListAsync(sql_, paras_, tm_, Fmo_configEO.MapDataReader);
		}
		...
		/// /// <param name = "currencyID">货币编码（ISO 4217大写）</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByCurrencyID(string currencyID)
		{
			return GetByCurrencyID(currencyID, 0, string.Empty, null);
		}
		public async Task<List<Fmo_configEO>> GetByCurrencyIDAsync(string currencyID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByCurrencyID(string currencyID, TransactionManager tm_)
		{
			return GetByCurrencyID(currencyID, 0, string.Empty, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByCurrencyIDAsync(string currencyID, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByCurrencyID(string currencyID, int top_)
		{
			return GetByCurrencyID(currencyID, top_, string.Empty, null);
		}
		public async Task<List<Fmo_configEO>> GetByCurrencyIDAsync(string currencyID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByCurrencyID(string currencyID, int top_, TransactionManager tm_)
		{
			return GetByCurrencyID(currencyID, top_, string.Empty, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByCurrencyIDAsync(string currencyID, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByCurrencyID(string currencyID, string sort_)
		{
			return GetByCurrencyID(currencyID, 0, sort_, null);
		}
		public async Task<List<Fmo_configEO>> GetByCurrencyIDAsync(string currencyID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByCurrencyID(string currencyID, string sort_, TransactionManager tm_)
		{
			return GetByCurrencyID(currencyID, 0, sort_, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByCurrencyIDAsync(string currencyID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByCurrencyID(string currencyID, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fmo_configEO>> GetByCurrencyIDAsync(string currencyID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`CurrencyID` = @CurrencyID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@CurrencyID", currencyID, MySqlDbType.VarChar));
		...
		/// /// <param name = "incomeRatio">税收分配</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByIncomeRatio(double incomeRatio)
		{
			return GetByIncomeRatio(incomeRatio, 0, string.Empty, null);
		}
		public async Task<List<Fmo_configEO>> GetByIncomeRatioAsync(double incomeRatio)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByIncomeRatio(double incomeRatio, TransactionManager tm_)
		{
			return GetByIncomeRatio(incomeRatio, 0, string.Empty, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByIncomeRatioAsync(double incomeRatio, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByIncomeRatio(double incomeRatio, int top_)
		{
			return GetByIncomeRatio(incomeRatio, top_, string.Empty, null);
		}
		public async Task<List<Fmo_configEO>> GetByIncomeRatioAsync(double incomeRatio, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByIncomeRatio(double incomeRatio, int top_, TransactionManager tm_)
		{
			return GetByIncomeRatio(incomeRatio, top_, string.Empty, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByIncomeRatioAsync(double incomeRatio, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByIncomeRatio(double incomeRatio, string sort_)
		{
			return GetByIncomeRatio(incomeRatio, 0, sort_, null);
		}
		public async Task<List<Fmo_configEO>> GetByIncomeRatioAsync(double incomeRatio, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByIncomeRatio(double incomeRatio, string sort_, TransactionManager tm_)
		{
			return GetByIncomeRatio(incomeRatio, 0, sort_, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByIncomeRatioAsync(double incomeRatio, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByIncomeRatio(double incomeRatio, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fmo_configEO>> GetByIncomeRatioAsync(double incomeRatio, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`IncomeRatio` = @IncomeRatio", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@IncomeRatio", incomeRatio, MySqlDbType.Double));
		...
		/// /// <param name = "multipArray">倍率集合</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByMultipArray(string multipArray)
		{
			return GetByMultipArray(multipArray, 0, string.Empty, null);
		}
		public async Task<List<Fmo_configEO>> GetByMultipArrayAsync(string multipArray)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByMultipArray(string multipArray, TransactionManager tm_)
		{
			return GetByMultipArray(multipArray, 0, string.Empty, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByMultipArrayAsync(string multipArray, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByMultipArray(string multipArray, int top_)
		{
			return GetByMultipArray(multipArray, top_, string.Empty, null);
		}
		public async Task<List<Fmo_configEO>> GetByMultipArrayAsync(string multipArray, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByMultipArray(string multipArray, int top_, TransactionManager tm_)
		{
			return GetByMultipArray(multipArray, top_, string.Empty, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByMultipArrayAsync(string multipArray, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByMultipArray(string multipArray, string sort_)
		{
			return GetByMultipArray(multipArray, 0, sort_, null);
		}
		public async Task<List<Fmo_configEO>> GetByMultipArrayAsync(string multipArray, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByMultipArray(string multipArray, string sort_, TransactionManager tm_)
		{
			return GetByMultipArray(multipArray, 0, sort_, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByMultipArrayAsync(string multipArray, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByMultipArray(string multipArray, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fmo_configEO>> GetByMultipArrayAsync(string multipArray, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL(multipArray != null ? "`MultipArray` = @MultipArray" : "`MultipArray` IS NULL", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			if (multipArray != null)
		...
		/// /// <param name = "defaultSlotArray">初始牌面</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByDefaultSlotArray(string defaultSlotArray)
		{
			return GetByDefaultSlotArray(defaultSlotArray, 0, string.Empty, null);
		}
		public async Task<List<Fmo_configEO>> GetByDefaultSlotArrayAsync(string defaultSlotArray)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByDefaultSlotArray(string defaultSlotArray, TransactionManager tm_)
		{
			return GetByDefaultSlotArray(defaultSlotArray, 0, string.Empty, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByDefaultSlotArrayAsync(string defaultSlotArray, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByDefaultSlotArray(string defaultSlotArray, int top_)
		{
			return GetByDefaultSlotArray(defaultSlotArray, top_, string.Empty, null);
		}
		public async Task<List<Fmo_configEO>> GetByDefaultSlotArrayAsync(string defaultSlotArray, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByDefaultSlotArray(string defaultSlotArray, int top_, TransactionManager tm_)
		{
			return GetByDefaultSlotArray(defaultSlotArray, top_, string.Empty, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByDefaultSlotArrayAsync(string defaultSlotArray, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByDefaultSlotArray(string defaultSlotArray, string sort_)
		{
			return GetByDefaultSlotArray(defaultSlotArray, 0, sort_, null);
		}
		public async Task<List<Fmo_configEO>> GetByDefaultSlotArrayAsync(string defaultSlotArray, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByDefaultSlotArray(string defaultSlotArray, string sort_, TransactionManager tm_)
		{
			return GetByDefaultSlotArray(defaultSlotArray, 0, sort_, tm_);
		}
		public async Task<List<Fmo_configEO>> GetByDefaultSlotArrayAsync(string defaultSlotArray, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fmo_configEO> GetByDefaultSlotArray(string defaultSlotArray, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fmo_configEO>> GetByDefaultSlotArrayAsync(string defaultSlotArray, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL(defaultSlotArray != null ? "`DefaultSlotArray` = @DefaultSlotArray" : "`DefaultSlotArray` IS NULL", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			if (defaultSlotArray != null)
