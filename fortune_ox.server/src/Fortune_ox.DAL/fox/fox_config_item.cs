...
namespace Fortune_ox.DAL
{
	...
	/// <summary>
	/// 图标ICON权重表
	/// 【表 fox_config_item 的实体类】
	/// </summary>
	[DataContract]
	[Obsolete]
	public class Fox_config_itemEO : IRowMapper<Fox_config_itemEO>
	{
		/// <summary>
		/// 构造函数 
		/// </summary>
		public Fox_config_itemEO()
		{
		}
		#region 主键原始值 & 主键集合
		...
		/// <return>实体对象</return>
		public Fox_config_itemEO MapRow(IDataReader reader)
		{
		...
		/// <param name = "reader">只进结果集流</param>
		/// <return>实体对象</return>
		public static Fox_config_itemEO MapDataReader(IDataReader reader)
		{
		    Fox_config_itemEO ret = new Fox_config_itemEO();
	...
	/// <summary>
	/// 图标ICON权重表
	/// 【表 fox_config_item 的操作类】
	/// </summary>
	[Obsolete]
	public class Fox_config_itemMO : MySqlTableMO<Fox_config_itemEO>
	{
		/// <summary>
		/// 表名
		/// </summary>
	    public override string TableName { get; set; } = "`fox_config_item`";
		...
		public Fox_config_itemMO(MySqlDatabase database) : base(database) { }
		/// <summary>
		/// 构造函数
		/// </summary>
		/// <param name = "connectionStringName">配置文件.config中定义的连接字符串名称</param>
		public Fox_config_itemMO(string connectionStringName = null) : base(connectionStringName) { }
	    /// <summary>
	    /// 构造函数
	    /// </summary>
	    /// <param name="connectionString">数据库连接字符串，如server=192.168.1.1;database=testdb;uid=root;pwd=root</param>
	    /// <param name="commandTimeout">CommandTimeout时间</param>
	    public Fox_config_itemMO(string connectionString, int commandTimeout) : base(connectionString, commandTimeout) { }
		...
		public override int Add(Fox_config_itemEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_); 
		}
		public override async Task<int> AddAsync(Fox_config_itemEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_); 
		}
	    private void RepairAddData(Fox_config_itemEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		public int AddByBatch(IEnumerable<Fox_config_itemEO> items, int batchCount, TransactionManager tm_ = null)
		{
			var ret = 0;
	    ...
	    public async Task<int> AddByBatchAsync(IEnumerable<Fox_config_itemEO> items, int batchCount, TransactionManager tm_ = null)
	    {
	        var ret = 0;
	        foreach (var sql in BuildAddBatchSql(items, batchCount))
	        {
	    ...
	    private IEnumerable<string> BuildAddBatchSql(IEnumerable<Fox_config_itemEO> items, int batchCount)
		{
			var count = 0;
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Remove(Fox_config_itemEO item, TransactionManager tm_ = null)
		{
			return RemoveByPK(item.ItemID, item.IconType, tm_);
		}
		public async Task<int> RemoveAsync(Fox_config_itemEO item, TransactionManager tm_ = null)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(Fox_config_itemEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutAsync(Fox_config_itemEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutData(Fox_config_itemEO item, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(IEnumerable<Fox_config_itemEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public async Task<int> PutAsync(IEnumerable<Fox_config_itemEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public bool Set(Fox_config_itemEO item, TransactionManager tm = null)
		{
			bool ret = true;
		...
		public async Task<bool> SetAsync(Fox_config_itemEO item, TransactionManager tm = null)
		{
			bool ret = true;
			if(GetByPK(item.ItemID, item.IconType) == null)
			{
		...
		/// <return></return>
		public Fox_config_itemEO GetByPK(int itemID, int iconType, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(itemID, iconType, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return Database.ExecSqlSingle(sql_, paras_, tm_, Fox_config_itemEO.MapDataReader);
		}
		public async Task<Fox_config_itemEO> GetByPKAsync(int itemID, int iconType, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(itemID, iconType, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Fox_config_itemEO.MapDataReader);
		}
		...
		public List<Fox_config_itemEO> GetByItemID(int itemID)
		{
			return GetByItemID(itemID, 0, string.Empty, null);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemIDAsync(int itemID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemID(int itemID, TransactionManager tm_)
		{
			return GetByItemID(itemID, 0, string.Empty, tm_);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemIDAsync(int itemID, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemID(int itemID, int top_)
		{
			return GetByItemID(itemID, top_, string.Empty, null);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemIDAsync(int itemID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemID(int itemID, int top_, TransactionManager tm_)
		{
			return GetByItemID(itemID, top_, string.Empty, tm_);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemIDAsync(int itemID, int top_, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemID(int itemID, string sort_)
		{
			return GetByItemID(itemID, 0, sort_, null);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemIDAsync(int itemID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemID(int itemID, string sort_, TransactionManager tm_)
		{
			return GetByItemID(itemID, 0, sort_, tm_);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemIDAsync(int itemID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemID(int itemID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`ItemID` = @ItemID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@ItemID", itemID, MySqlDbType.Int32));
			return Database.ExecSqlList(sql_, paras_, tm_, Fox_config_itemEO.MapDataReader);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemIDAsync(int itemID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`ItemID` = @ItemID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@ItemID", itemID, MySqlDbType.Int32));
			return await Database.ExecSqlListAsync(sql_, paras_, tm_, Fox_config_itemEO.MapDataReader);
		}
		...
		/// /// <param name = "iconType">1-普通,2-万能</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByIconType(int iconType)
		{
			return GetByIconType(iconType, 0, string.Empty, null);
		}
		public async Task<List<Fox_config_itemEO>> GetByIconTypeAsync(int iconType)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByIconType(int iconType, TransactionManager tm_)
		{
			return GetByIconType(iconType, 0, string.Empty, tm_);
		}
		public async Task<List<Fox_config_itemEO>> GetByIconTypeAsync(int iconType, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByIconType(int iconType, int top_)
		{
			return GetByIconType(iconType, top_, string.Empty, null);
		}
		public async Task<List<Fox_config_itemEO>> GetByIconTypeAsync(int iconType, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByIconType(int iconType, int top_, TransactionManager tm_)
		{
			return GetByIconType(iconType, top_, string.Empty, tm_);
		}
		public async Task<List<Fox_config_itemEO>> GetByIconTypeAsync(int iconType, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByIconType(int iconType, string sort_)
		{
			return GetByIconType(iconType, 0, sort_, null);
		}
		public async Task<List<Fox_config_itemEO>> GetByIconTypeAsync(int iconType, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByIconType(int iconType, string sort_, TransactionManager tm_)
		{
			return GetByIconType(iconType, 0, sort_, tm_);
		}
		public async Task<List<Fox_config_itemEO>> GetByIconTypeAsync(int iconType, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByIconType(int iconType, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fox_config_itemEO>> GetByIconTypeAsync(int iconType, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`IconType` = @IconType", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@IconType", iconType, MySqlDbType.Int32));
		...
		/// /// <param name = "itemName">图标名字</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemName(string itemName)
		{
			return GetByItemName(itemName, 0, string.Empty, null);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemNameAsync(string itemName)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemName(string itemName, TransactionManager tm_)
		{
			return GetByItemName(itemName, 0, string.Empty, tm_);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemNameAsync(string itemName, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemName(string itemName, int top_)
		{
			return GetByItemName(itemName, top_, string.Empty, null);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemNameAsync(string itemName, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemName(string itemName, int top_, TransactionManager tm_)
		{
			return GetByItemName(itemName, top_, string.Empty, tm_);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemNameAsync(string itemName, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemName(string itemName, string sort_)
		{
			return GetByItemName(itemName, 0, sort_, null);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemNameAsync(string itemName, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemName(string itemName, string sort_, TransactionManager tm_)
		{
			return GetByItemName(itemName, 0, sort_, tm_);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemNameAsync(string itemName, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemName(string itemName, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fox_config_itemEO>> GetByItemNameAsync(string itemName, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`ItemName` = @ItemName", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@ItemName", itemName, MySqlDbType.VarChar));
		...
		/// /// <param name = "itemBaseMultip">图标ICON基础倍率</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemBaseMultip(int itemBaseMultip)
		{
			return GetByItemBaseMultip(itemBaseMultip, 0, string.Empty, null);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemBaseMultipAsync(int itemBaseMultip)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemBaseMultip(int itemBaseMultip, TransactionManager tm_)
		{
			return GetByItemBaseMultip(itemBaseMultip, 0, string.Empty, tm_);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemBaseMultipAsync(int itemBaseMultip, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemBaseMultip(int itemBaseMultip, int top_)
		{
			return GetByItemBaseMultip(itemBaseMultip, top_, string.Empty, null);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemBaseMultipAsync(int itemBaseMultip, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemBaseMultip(int itemBaseMultip, int top_, TransactionManager tm_)
		{
			return GetByItemBaseMultip(itemBaseMultip, top_, string.Empty, tm_);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemBaseMultipAsync(int itemBaseMultip, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemBaseMultip(int itemBaseMultip, string sort_)
		{
			return GetByItemBaseMultip(itemBaseMultip, 0, sort_, null);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemBaseMultipAsync(int itemBaseMultip, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemBaseMultip(int itemBaseMultip, string sort_, TransactionManager tm_)
		{
			return GetByItemBaseMultip(itemBaseMultip, 0, sort_, tm_);
		}
		public async Task<List<Fox_config_itemEO>> GetByItemBaseMultipAsync(int itemBaseMultip, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Fox_config_itemEO> GetByItemBaseMultip(int itemBaseMultip, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Fox_config_itemEO>> GetByItemBaseMultipAsync(int itemBaseMultip, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`ItemBaseMultip` = @ItemBaseMultip", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@ItemBaseMultip", itemBaseMultip, MySqlDbType.Int32));
